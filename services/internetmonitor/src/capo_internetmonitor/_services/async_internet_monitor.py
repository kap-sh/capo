...
class AsyncInternetMonitorClient:
    ...
    async def iter_list_internet_events(
        self,
        *,
        config_overrides: Optional[AsyncInternetMonitorClientConfig] = None,
        next_token: Optional[str] = None,
        ...
        event_status: Optional[str] = None,
        event_type: Optional[str] = None,
    ) -> "AsyncIterator[capo_internetmonitor.types.internet_event_summary.InternetEventSummary]":
        _token = next_token
        while True:
            _response = await self.list_internet_events(
    ...
    async def iter_list_monitors(
        ...
        *,
        ...
        monitor_status: Optional[str] = None,
        include_linked_accounts: Optional[bool] = None,
    ) -> "AsyncIterator[capo_internetmonitor.types.monitor.Monitor]":
        _token = next_token
        while True:
    ...
    ) -> "AsyncIterator[capo_internetmonitor.types.get_query_results_output.GetQueryResultsOutput]":
        _token = next_token
        while True:
    ...
    async def get_health_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_internetmonitor.types.get_health_event_input.GetHealthEventInput]",
        ) -> AsyncOperationResponse[
            "capo_internetmonitor.types.get_health_event_output.GetHealthEventOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_internetmonitor._operations.internet_monitor20210603.get_health_event.async_get_health_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_health_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_internetmonitor.types.list_health_events_input.ListHealthEventsInput]",
        ) -> AsyncOperationResponse[
            "capo_internetmonitor.types.list_health_events_output.ListHealthEventsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_internetmonitor._operations.internet_monitor20210603.list_health_events.async_list_health_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_health_events(
        self,
        monitor_name: "capo_internetmonitor.types.resource_name.ResourceName",
        *,
        config_overrides: Optional[AsyncInternetMonitorClientConfig] = None,
    ...
    ) -> "AsyncIterator[capo_internetmonitor.types.health_event.HealthEvent]":
        _token = next_token
        while True:
            _response = await self.list_health_events(
                monitor_name,
                config_overrides=config_overrides,
                start_time=start_time,
                end_time=end_time,
