...
class GroundStationClient:
    ...
    ) -> "Iterator[capo_groundstation.types.config_list_item.ConfigListItem]":
        _token = next_token
        while True:
            _response = self.list_configs(
    ...
    ) -> "Iterator[capo_groundstation.types.contact_data.ContactData]":
        _token = next_token
        while True:
    ...
    def iter_list_contact_versions(
        self,
        contact_id: "capo_groundstation.types.uuid.Uuid",
        *,
        config_overrides: Optional[GroundStationClientConfig] = None,
    ...
    ) -> "Iterator[capo_groundstation.types.contact_version.ContactVersion]":
        _token = next_token
        while True:
            _response = self.list_contact_versions(
                contact_id,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    def iter_list_dataflow_endpoint_groups(
        self,
        *,
        config_overrides: Optional[GroundStationClientConfig] = None,
        max_results: Optional[
    ...
    ) -> "Iterator[capo_groundstation.types.dataflow_endpoint_list_item.DataflowEndpointListItem]":
        _token = next_token
        while True:
            _response = self.list_dataflow_endpoint_groups(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    ) -> "Iterator[capo_groundstation.types.ephemeris_item.EphemerisItem]":
        _token = next_token
        while True:
            _response = self.list_ephemerides(
                start_time,
                end_time,
                config_overrides=config_overrides,
    ...
    ) -> "Iterator[capo_groundstation.types.ground_station_data.GroundStationData]":
        _token = next_token
        while True:
            _response = self.list_ground_stations(
                config_overrides=config_overrides,
                satellite_id=satellite_id,
                max_results=max_results,
                next_token=_token,
    ...
    ) -> "Iterator[capo_groundstation.types.antenna_list_item.AntennaListItem]":
        _token = next_token
        while True:
            _response = self.list_antennas(
                ground_station_id,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    def iter_list_ground_station_reservations(
        self,
        ground_station_id: "capo_groundstation.types.ground_station_name.GroundStationName",
        start_time: datetime.datetime,
        end_time: datetime.datetime,
    ...
    ) -> "Iterator[capo_groundstation.types.ground_station_reservation_list_item.GroundStationReservationListItem]":
        _token = next_token
        while True:
            _response = self.list_ground_station_reservations(
                ground_station_id,
                start_time,
                end_time,
                config_overrides=config_overrides,
    ...
    def iter_list_mission_profiles(
        self,
        *,
        config_overrides: Optional[GroundStationClientConfig] = None,
        max_results: Optional[
    ...
    ) -> "Iterator[capo_groundstation.types.mission_profile_list_item.MissionProfileListItem]":
        _token = next_token
        while True:
            _response = self.list_mission_profiles(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    ) -> "Iterator[capo_groundstation.types.satellite_list_item.SatelliteListItem]":
        _token = next_token
        while True:
            _response = self.list_satellites(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
