"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#TerminateMicrovm``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.terminate_microvm_response.TerminateMicrovmResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_terminate_microvm(
