"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#GetMicrovmImage``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.get_microvm_image_output.GetMicrovmImageOutput = (
        capo_lambda_microvms.types.get_microvm_image_output.deserialize_json(
...
async def async_get_microvm_image(
