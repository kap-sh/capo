"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#SuspendMicrovm``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.suspend_microvm_response.SuspendMicrovmResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2025-09-09/microvms/{microvmIdentifier}/suspend"
    url = url.replace(
...
async def async_suspend_microvm(
