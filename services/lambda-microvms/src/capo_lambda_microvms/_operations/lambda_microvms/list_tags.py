"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#ListTags``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.list_tags_response.ListTagsResponse = (
        capo_lambda_microvms.types.list_tags_response.deserialize_json(
...
def list_tags(
    ...
    capo_lambda_microvms.types.list_tags_response.ListTagsResponse, zapros.Response
]:
