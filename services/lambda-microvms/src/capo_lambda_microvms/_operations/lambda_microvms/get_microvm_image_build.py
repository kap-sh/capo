"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#GetMicrovmImageBuild``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.get_microvm_image_build_output.GetMicrovmImageBuildOutput = capo_lambda_microvms.types.get_microvm_image_build_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{buildId}", quote(input_["build_id"], safe=""))
...
async def async_get_microvm_image_build(
