"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#ListManagedMicrovmImageVersions``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.list_managed_microvm_image_versions_output.ListManagedMicrovmImageVersionsOutput = capo_lambda_microvms.types.list_managed_microvm_image_versions_output.deserialize_json(
...
async def async_list_managed_microvm_image_versions(
