"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#TagResource``."""
...
import capo_lambda_microvms.errors.invalid_parameter_value_exception
import capo_lambda_microvms.errors.resource_conflict_exception
import capo_lambda_microvms.errors.resource_not_found_exception
import capo_lambda_microvms.errors.service_exception
import capo_lambda_microvms.errors.throttling_exception
import capo_lambda_microvms.errors.too_many_requests_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterValueException":
            raise capo_lambda_microvms.errors.invalid_parameter_value_exception.InvalidParameterValueException.from_json(
                data, message
            )
        case "ResourceConflictException":
            raise capo_lambda_microvms.errors.resource_conflict_exception.ResourceConflictException.from_json(
                data, message
            )
        ...
        case "ServiceException":
            raise capo_lambda_microvms.errors.service_exception.ServiceException.from_json(
                data, message
            )
        case "TooManyRequestsException":
            raise capo_lambda_microvms.errors.too_many_requests_exception.TooManyRequestsException.from_json(
                data, message
            )
        case _:
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda_microvms.types.tag_resource_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
