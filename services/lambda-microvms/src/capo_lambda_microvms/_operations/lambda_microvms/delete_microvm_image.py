"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#DeleteMicrovmImage``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.delete_microvm_image_output.DeleteMicrovmImageOutput = capo_lambda_microvms.types.delete_microvm_image_output.deserialize_json(
...
async def async_delete_microvm_image(
