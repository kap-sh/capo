"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#ListMicrovms``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.list_microvms_response.ListMicrovmsResponse = (
        capo_lambda_microvms.types.list_microvms_response.deserialize_json(
...
def build_request(
    ...
    if "image_identifier" in input_:
        params.append(("imageIdentifier", input_["image_identifier"]))
    if "image_version" in input_:
        params.append(("imageVersion", input_["image_version"]))
