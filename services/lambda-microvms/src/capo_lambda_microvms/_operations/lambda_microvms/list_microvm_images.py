"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#ListMicrovmImages``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.list_microvm_images_response.ListMicrovmImagesResponse = capo_lambda_microvms.types.list_microvm_images_response.deserialize_json(
...
async def async_list_microvm_images(
