"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#ListManagedMicrovmImages``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.list_managed_microvm_images_output.ListManagedMicrovmImagesOutput = capo_lambda_microvms.types.list_managed_microvm_images_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2025-09-09/managed-microvm-images"
...
async def async_list_managed_microvm_images(
