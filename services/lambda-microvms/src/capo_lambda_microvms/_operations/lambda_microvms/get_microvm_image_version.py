"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#GetMicrovmImageVersion``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.get_microvm_image_version_output.GetMicrovmImageVersionOutput = capo_lambda_microvms.types.get_microvm_image_version_output.deserialize_json(
...
async def async_get_microvm_image_version(
