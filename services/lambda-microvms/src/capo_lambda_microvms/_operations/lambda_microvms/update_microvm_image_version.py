"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#UpdateMicrovmImageVersion``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.update_microvm_image_version_response.UpdateMicrovmImageVersionResponse = capo_lambda_microvms.types.update_microvm_image_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda_microvms.types.update_microvm_image_version_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_microvm_image_version(
