"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#DeleteMicrovmImageVersion``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.delete_microvm_image_version_output.DeleteMicrovmImageVersionOutput = capo_lambda_microvms.types.delete_microvm_image_version_output.deserialize_json(
...
async def async_delete_microvm_image_version(
