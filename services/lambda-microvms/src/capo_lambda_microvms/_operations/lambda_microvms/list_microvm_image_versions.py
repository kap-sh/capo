"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#ListMicrovmImageVersions``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.list_microvm_image_versions_output.ListMicrovmImageVersionsOutput = capo_lambda_microvms.types.list_microvm_image_versions_output.deserialize_json(
...
async def async_list_microvm_image_versions(
