"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#GetMicrovm``."""
...
def handle_response(
    ...
    out: capo_lambda_microvms.types.get_microvm_response.GetMicrovmResponse = (
        capo_lambda_microvms.types.get_microvm_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2025-09-09/microvms/{microvmIdentifier}"
    url = url.replace(
...
def get_microvm(
    ...
    capo_lambda_microvms.types.get_microvm_response.GetMicrovmResponse, zapros.Response
]:
