"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lambdamicrovms#ValidationException``."""
