...
class LambdaMicrovmsError(Exception):
    """Base class for all LambdaMicrovms service errors."""


class ServiceError(LambdaMicrovmsError):
...
class SerializationError(LambdaMicrovmsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LambdaMicrovmsError):
...
class WaiterFailedError(LambdaMicrovmsError):
...
class WaiterTimeoutError(LambdaMicrovmsError):
