...
from capo_lambda_microvms._resources.lambda_microvms.microvm import Microvm
from capo_lambda_microvms._resources.lambda_microvms.microvm_image import MicrovmImage
from capo_lambda_microvms._services._aws_config import aws_config
...
class LambdaMicrovmsClientConfig(TypedDict, total=False, closed=True):
...
class LambdaMicrovmsClient:
    ...
    def __init__(
        ...
        self._config = LambdaMicrovmsClientConfig(
            {
        ...
        # resources
        self.microvm = Microvm(self)
        self.microvm_image = MicrovmImage(self)

    def operation_options(
        self, config_overrides: Optional[LambdaMicrovmsClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: LambdaMicrovmsClientConfig = config_overrides or {}
    ...
    def create_microvm_image(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_lambda_microvms.types.create_microvm_image_request.CreateMicrovmImageRequest]",
        ) -> OperationResponse[
            "capo_lambda_microvms.types.create_microvm_image_response.CreateMicrovmImageResponse"
        ]:
            ...
            output, http_response = (
                capo_lambda_microvms._operations.lambda_microvms.create_microvm_image.create_microvm_image(
    ...
    def list_managed_microvm_images(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_lambda_microvms.types.list_managed_microvm_images_input.ListManagedMicrovmImagesInput]",
        ) -> OperationResponse[
            "capo_lambda_microvms.types.list_managed_microvm_images_output.ListManagedMicrovmImagesOutput"
        ]:
            ...
            output, http_response = (
                capo_lambda_microvms._operations.lambda_microvms.list_managed_microvm_images.list_managed_microvm_images(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_managed_microvm_images(
        self,
        *,
        config_overrides: Optional[LambdaMicrovmsClientConfig] = None,
        max_results: Optional[int] = None,
        next_token: Optional["capo_lambda_microvms.types.string.String"] = None,
    ) -> "Iterator[capo_lambda_microvms.types.managed_microvm_image_summary.ManagedMicrovmImageSummary]":
        _token = next_token
        while True:
            _response = self.list_managed_microvm_images(
    ...
    def list_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_lambda_microvms.types.list_tags_request.ListTagsRequest]",
        ) -> OperationResponse[
            "capo_lambda_microvms.types.list_tags_response.ListTagsResponse"
        ]:
            ...
            output, http_response = (
                capo_lambda_microvms._operations.lambda_microvms.list_tags.list_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_lambda_microvms.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import capo_lambda_microvms._operations.lambda_microvms.tag_resource

            output, http_response = (
                capo_lambda_microvms._operations.lambda_microvms.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_lambda_microvms.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import capo_lambda_microvms._operations.lambda_microvms.untag_resource

            output, http_response = (
                capo_lambda_microvms._operations.lambda_microvms.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_microvms(
        ...
        *,
        ...
        image_version: Optional[str] = None,
    ) -> "Iterator[capo_lambda_microvms.types.microvm_item.MicrovmItem]":
        _token = next_token
        while True:
            _response = self.list_microvms(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
                image_identifier=image_identifier,
    ...
    def iter_list_microvm_images(
        ...
        *,
        ...
        "Iterator[capo_lambda_microvms.types.microvm_image_summary.MicrovmImageSummary]"
    ):
        _token = next_token
        while True:
            _response = self.list_microvm_images(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    def iter_list_managed_microvm_image_versions(
        self,
        image_identifier: "capo_lambda_microvms.types.microvm_image_identifier.MicrovmImageIdentifier",
        *,
        config_overrides: Optional[LambdaMicrovmsClientConfig] = None,
        max_results: Optional[int] = None,
        next_token: Optional["capo_lambda_microvms.types.string.String"] = None,
    ) -> "Iterator[capo_lambda_microvms.types.managed_microvm_image_version.ManagedMicrovmImageVersion]":
        _token = next_token
        while True:
            _response = self.list_managed_microvm_image_versions(
                image_identifier,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    def iter_list_microvm_image_builds(
        self,
        image_identifier: "capo_lambda_microvms.types.microvm_image_identifier.MicrovmImageIdentifier",
        image_version: "capo_lambda_microvms.types.non_blank_string.NonBlankString",
        *,
    ...
    ) -> "Iterator[capo_lambda_microvms.types.microvm_image_build_summary.MicrovmImageBuildSummary]":
        _token = next_token
        while True:
            _response = self.list_microvm_image_builds(
                image_identifier,
                image_version,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    def iter_list_microvm_image_versions(
        self,
        image_identifier: "capo_lambda_microvms.types.microvm_image_identifier.MicrovmImageIdentifier",
        *,
        config_overrides: Optional[LambdaMicrovmsClientConfig] = None,
        max_results: Optional[int] = None,
        next_token: Optional["capo_lambda_microvms.types.string.String"] = None,
    ) -> "Iterator[capo_lambda_microvms.types.microvm_image_version_summary.MicrovmImageVersionSummary]":
        _token = next_token
        while True:
            _response = self.list_microvm_image_versions(
                image_identifier,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
