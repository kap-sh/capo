"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#CreateMicrovmImageResponse``."""
...
class CreateMicrovmImageResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateMicrovmImageResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateMicrovmImageResponse:
    out: CreateMicrovmImageResponse = {}  # type: ignore[typeddict-item]
    if data.get("imageArn") is not None:
        out["image_arn"] = data["imageArn"]
    else:
        raise DeserializationError("CreateMicrovmImageResponse.image_arn required")
    if data.get("name") is not None:
        out["name"] = data["name"]
    else:
        raise DeserializationError("CreateMicrovmImageResponse.name required")
    if data.get("state") is not None:
        ...
        raise DeserializationError("CreateMicrovmImageResponse.state required")
    ...
    if data.get("createdAt") is not None:
        ...
        raise DeserializationError("CreateMicrovmImageResponse.created_at required")
    if data.get("baseImageArn") is not None:
        out["base_image_arn"] = data["baseImageArn"]
    else:
        raise DeserializationError("CreateMicrovmImageResponse.base_image_arn required")
    ...
    if data.get("buildRoleArn") is not None:
        ...
        raise DeserializationError("CreateMicrovmImageResponse.build_role_arn required")
    ...
    if data.get("codeArtifact") is not None:
        ...
        raise DeserializationError("CreateMicrovmImageResponse.code_artifact required")
    ...
    if data.get("imageVersion") is not None:
        ...
        raise DeserializationError("CreateMicrovmImageResponse.image_version required")
    return out
