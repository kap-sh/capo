"""Generated from Smithy shape ``com.amazonaws.lambdamicrovms#UpdateMicrovmImageVersionResponse``."""
...
class UpdateMicrovmImageVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateMicrovmImageVersionResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateMicrovmImageVersionResponse:
    out: UpdateMicrovmImageVersionResponse = {}  # type: ignore[typeddict-item]
    if data.get("baseImageArn") is not None:
        out["base_image_arn"] = data["baseImageArn"]
    else:
        raise DeserializationError(
            "UpdateMicrovmImageVersionResponse.base_image_arn required"
        )
    ...
    if data.get("buildRoleArn") is not None:
        ...
        raise DeserializationError(
            "UpdateMicrovmImageVersionResponse.build_role_arn required"
        )
    ...
    if data.get("codeArtifact") is not None:
        ...
        raise DeserializationError(
            "UpdateMicrovmImageVersionResponse.code_artifact required"
        )
    ...
    if data.get("imageArn") is not None:
        ...
        raise DeserializationError(
            "UpdateMicrovmImageVersionResponse.image_arn required"
        )
    if data.get("imageVersion") is not None:
        out["image_version"] = data["imageVersion"]
    else:
        raise DeserializationError(
            "UpdateMicrovmImageVersionResponse.image_version required"
        )
    if data.get("state") is not None:
        ...
        raise DeserializationError("UpdateMicrovmImageVersionResponse.state required")
    if data.get("status") is not None:
        ...
        raise DeserializationError("UpdateMicrovmImageVersionResponse.status required")
    if data.get("createdAt") is not None:
        ...
        raise DeserializationError(
            "UpdateMicrovmImageVersionResponse.created_at required"
        )
