...
class EMRServerlessClient:
    ...
    ) -> "Iterator[capo_emr_serverless.types.application_summary.ApplicationSummary]":
        _token = next_token
        while True:
    ...
    def iter_list_job_runs(
        ...
        *,
        ...
        mode: Optional["capo_emr_serverless.types.job_run_mode.JobRunMode"] = None,
    ) -> "Iterator[capo_emr_serverless.types.job_run_summary.JobRunSummary]":
        _token = next_token
        while True:
    ...
    def iter_list_job_run_attempts(
        self,
        application_id: "capo_emr_serverless.types.application_id.ApplicationId",
        job_run_id: "capo_emr_serverless.types.job_run_id.JobRunId",
        *,
        ...
        next_token: Optional["capo_emr_serverless.types.next_token.NextToken"] = None,
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_emr_serverless.types.job_run_attempt_summary.JobRunAttemptSummary]":
        _token = next_token
        while True:
            _response = self.list_job_run_attempts(
                application_id,
                job_run_id,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    def iter_list_sessions(
        ...
        *,
        ...
        created_at_after: Optional["capo_emr_serverless.types.date.Date"] = None,
        created_at_before: Optional["capo_emr_serverless.types.date.Date"] = None,
    ) -> "Iterator[capo_emr_serverless.types.session_summary.SessionSummary]":
        _token = next_token
        while True:
