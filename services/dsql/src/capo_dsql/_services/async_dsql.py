...
class AsyncDSQLClient:
    ...
    async def create_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_cluster(deletion_protection_enabled=False, tags={'MyKey': 'MyValue'})
        """
    ...
    async def get_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_cluster(identifier='kiqenqglxyl2snyvkvnj2c3s2e')
        """
    ...
    async def wait_until_cluster_not_exists(
        self,
        identifier: "capo_dsql.types.cluster_id.ClusterId",
        *,
        max_wait_time: float,
        ...
        while True:
            ...
            try:
                op_output = await self.get_cluster(  # noqa: F841
    ...
    async def update_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_cluster(identifier='kiqenqglxyl2snyvkvnj2c3s2e', deletion_protection_enabled=False)
        """
    ...
    async def delete_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_cluster(identifier='kiqenqglxyl2snyvkvnj2c3s2e')
        """
    ...
    async def list_clusters(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_clusters(max_results=20)
        """
    ...
    async def iter_list_clusters(
        ...
        *,
        ...
        max_results: Optional["capo_dsql.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_dsql.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_dsql.types.cluster_summary.ClusterSummary]":
        _token = next_token
        while True:
    ...
    async def wait_until_stream_not_exists(
        ...
        *,
        ...
        while True:
            ...
            op_error: ServiceError | None = None
            try:
                op_output = await self.get_stream(  # noqa: F841
                    cluster_identifier,
                    stream_identifier,
                    config_overrides=config_overrides,
                )
    ...
    async def iter_list_streams(
        ...
        *,
        ...
        max_results: Optional["capo_dsql.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_dsql.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_dsql.types.stream_summary.StreamSummary]":
        _token = next_token
        while True:
