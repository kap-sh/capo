...
class AsyncgrafanaClient:
    ...
    async def iter_list_permissions(
        ...
        *,
        ...
        user_id: Optional["capo_grafana.types.sso_id.SsoId"] = None,
        group_id: Optional["capo_grafana.types.sso_id.SsoId"] = None,
    ) -> "AsyncIterator[capo_grafana.types.permission_entry.PermissionEntry]":
        _token = next_token
        while True:
    ...
    async def iter_list_workspace_service_accounts(
        self,
        workspace_id: "capo_grafana.types.workspace_id.WorkspaceId",
        *,
        config_overrides: Optional[AsyncgrafanaClientConfig] = None,
    ...
    ) -> "AsyncIterator[capo_grafana.types.service_account_summary.ServiceAccountSummary]":
        _token = next_token
        while True:
            _response = await self.list_workspace_service_accounts(
                workspace_id,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def iter_list_workspace_service_account_tokens(
        self,
        service_account_id: str,
        workspace_id: "capo_grafana.types.workspace_id.WorkspaceId",
        *,
    ...
    ) -> "AsyncIterator[capo_grafana.types.service_account_token_summary.ServiceAccountTokenSummary]":
        _token = next_token
        while True:
            _response = await self.list_workspace_service_account_tokens(
                service_account_id,
                workspace_id,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    ) -> "AsyncIterator[capo_grafana.types.workspace_summary.WorkspaceSummary]":
        _token = next_token
        while True:
