...
class AsyncControlCatalogClient:
    ...
    async def iter_list_common_controls(
        self,
        *,
        config_overrides: Optional[AsyncControlCatalogClientConfig] = None,
        max_results: Optional[
    ...
    ) -> "AsyncIterator[capo_controlcatalog.types.common_control_summary.CommonControlSummary]":
        _token = next_token
        while True:
            _response = await self.list_common_controls(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    ) -> "AsyncIterator[capo_controlcatalog.types.control_summary.ControlSummary]":
        _token = next_token
        while True:
    ...
    ) -> "AsyncIterator[capo_controlcatalog.types.domain_summary.DomainSummary]":
        _token = next_token
        while True:
    ...
    async def iter_list_objectives(
        self,
        *,
        config_overrides: Optional[AsyncControlCatalogClientConfig] = None,
        max_results: Optional[
    ...
    ) -> "AsyncIterator[capo_controlcatalog.types.objective_summary.ObjectiveSummary]":
        _token = next_token
        while True:
            _response = await self.list_objectives(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
