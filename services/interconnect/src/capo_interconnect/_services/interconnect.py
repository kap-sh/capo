...
class InterconnectClient:
    ...
    def create_connection(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_connection(bandwidth='1Gbps', environment_id='mce-aws-acme-1', remote_account={'identifier': 'PartnerAccountDetails'}, attach_point={'directConnectGateway': '90392BE3-219C-47FD-BBA5-03DF76D2542A'})
        """
    ...
    def get_connection(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_connection(identifier='mcc-abc12345')
        """
    ...
    def update_connection(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_connection(identifier='mcc-abc12345', description='Changed Description')
            Update Connection Bandwidth

            >>> client.update_connection(identifier='mcc-abc12345', bandwidth='2Gbps')
        """
    ...
    def delete_connection(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_connection(identifier='mcc-abc12345')
        """
    ...
    def list_connections(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_connections(state='available')
            List Connections on specific Environment

            >>> client.list_connections(environment_id='mce-aws-acme-1')
        """
    ...
    ) -> "Iterator[capo_interconnect.types.connection_summary.ConnectionSummary]":
        _token = next_token
        while True:
    ...
    def get_environment(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_environment(id='mce-aws-acme-1')
        """
    ...
    def iter_list_environments(
        ...
        *,
        ...
        provider: Optional["capo_interconnect.types.provider.Provider"] = None,
        location: Optional["capo_interconnect.types.location.Location"] = None,
    ) -> "Iterator[capo_interconnect.types.environment.Environment]":
        _token = next_token
        while True:
