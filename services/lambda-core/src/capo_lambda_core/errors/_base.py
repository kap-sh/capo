...
class LambdaCoreError(Exception):
    """Base class for all LambdaCore service errors."""


class ServiceError(LambdaCoreError):
...
class SerializationError(LambdaCoreError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LambdaCoreError):
...
class WaiterFailedError(LambdaCoreError):
...
class WaiterTimeoutError(LambdaCoreError):
