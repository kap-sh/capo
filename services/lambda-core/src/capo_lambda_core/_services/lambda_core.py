...
from capo_lambda_core._services._aws_config import aws_config
...
class LambdaCoreClientConfig(TypedDict, total=False, closed=True):
...
class LambdaCoreClient:
    ...
    def __init__(
        ...
        self._config = LambdaCoreClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[LambdaCoreClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: LambdaCoreClientConfig = config_overrides or {}
    ...
    def iter_list_network_connectors(
        self,
        *,
        config_overrides: Optional[LambdaCoreClientConfig] = None,
        state: Optional[
    ...
    ) -> "Iterator[capo_lambda_core.types.network_connector_summary.NetworkConnectorSummary]":
        _token = marker
        while True:
            _response = self.list_network_connectors(
