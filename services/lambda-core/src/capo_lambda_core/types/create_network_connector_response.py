"""Generated from Smithy shape ``com.amazonaws.lambdacore#CreateNetworkConnectorResponse``."""
...
class CreateNetworkConnectorResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateNetworkConnectorResponse) -> dict:
    out: dict = {}
    out["Arn"] = value["arn"]
    out["Name"] = value["name"]
    out["Id"] = value["id"]
...
def deserialize_json(data: dict) -> CreateNetworkConnectorResponse:
    out: CreateNetworkConnectorResponse = {}  # type: ignore[typeddict-item]
    if data.get("Arn") is not None:
        out["arn"] = data["Arn"]
    else:
        raise DeserializationError("CreateNetworkConnectorResponse.arn required")
    if data.get("Name") is not None:
        out["name"] = data["Name"]
    else:
        raise DeserializationError("CreateNetworkConnectorResponse.name required")
    if data.get("Id") is not None:
        out["id"] = data["Id"]
    else:
        raise DeserializationError("CreateNetworkConnectorResponse.id required")
