"""Generated from Smithy shape ``com.amazonaws.lambdacore#CreateNetworkConnector``."""
...
import capo_lambda_core.errors.network_connector_limit_exceeded_exception
import capo_lambda_core.errors.resource_conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NetworkConnectorLimitExceededException":
            raise capo_lambda_core.errors.network_connector_limit_exceeded_exception.NetworkConnectorLimitExceededException.from_json(
                data, message
            )
        case "ResourceConflictException":
            raise capo_lambda_core.errors.resource_conflict_exception.ResourceConflictException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_lambda_core.types.create_network_connector_response.CreateNetworkConnectorResponse = capo_lambda_core.types.create_network_connector_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda_core.types.create_network_connector_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_network_connector(
