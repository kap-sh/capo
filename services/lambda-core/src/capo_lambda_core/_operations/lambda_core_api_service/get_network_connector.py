"""Generated from Smithy shape ``com.amazonaws.lambdacore#GetNetworkConnector``."""
...
def handle_response(
    ...
    out: capo_lambda_core.types.get_network_connector_response.GetNetworkConnectorResponse = capo_lambda_core.types.get_network_connector_response.deserialize_json(
...
async def async_get_network_connector(
