"""Generated from Smithy shape ``com.amazonaws.lambdacore#DeleteNetworkConnector``."""
...
def handle_response(
    ...
    out: capo_lambda_core.types.delete_network_connector_response.DeleteNetworkConnectorResponse = capo_lambda_core.types.delete_network_connector_response.deserialize_json(
...
async def async_delete_network_connector(
