"""Generated from Smithy shape ``com.amazonaws.supportauthz#ListActions``."""
...
def handle_response(
    ...
    out: capo_supportauthz.types.list_actions_output.ListActionsOutput = (
        capo_supportauthz.types.list_actions_output.deserialize_json(
...
def build_request(
    ...
    if "service" in input_:
        params.append(("service", input_["service"]))
...
def list_actions(
    ...
    capo_supportauthz.types.list_actions_output.ListActionsOutput, zapros.Response
]:
