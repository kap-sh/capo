"""Generated from Smithy shape ``com.amazonaws.supportauthz#GetSupportPermit``."""
...
def handle_response(
    ...
    out: capo_supportauthz.types.get_support_permit_output.GetSupportPermitOutput = (
        capo_supportauthz.types.get_support_permit_output.deserialize_json(
...
async def async_get_support_permit(
