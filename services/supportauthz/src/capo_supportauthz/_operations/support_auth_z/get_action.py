"""Generated from Smithy shape ``com.amazonaws.supportauthz#GetAction``."""
...
def handle_response(
    ...
    out: capo_supportauthz.types.get_action_output.GetActionOutput = (
        capo_supportauthz.types.get_action_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/actions/{action}"
    url = url.replace("{action}", quote(input_["action"], safe=""))
...
def get_action(
    ...
    input_: capo_supportauthz.types.get_action_input.GetActionInput,
) -> tuple[capo_supportauthz.types.get_action_output.GetActionOutput, zapros.Response]:
