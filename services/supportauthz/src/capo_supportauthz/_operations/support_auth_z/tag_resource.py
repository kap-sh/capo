"""Generated from Smithy shape ``com.amazonaws.supportauthz#TagResource``."""
...
def handle_response(
    ...
    out: capo_supportauthz.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_supportauthz.types.tag_resource_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_supportauthz.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
