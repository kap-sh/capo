"""Generated from Smithy shape ``com.amazonaws.supportauthz#ListSupportPermits``."""
...
def handle_response(
    ...
    out: capo_supportauthz.types.list_support_permits_output.ListSupportPermitsOutput = capo_supportauthz.types.list_support_permits_output.deserialize_json(
...
def build_request(
    ...
    if "support_permit_statuses" in input_:
        for item in input_["support_permit_statuses"]:
            params.append(
                (
                    "supportPermitStatuses",
                    capo_supportauthz.types.support_permit_status.serialize_json(item),
                )
            )
...
async def async_list_support_permits(
