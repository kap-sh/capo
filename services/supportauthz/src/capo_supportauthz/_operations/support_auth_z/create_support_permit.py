"""Generated from Smithy shape ``com.amazonaws.supportauthz#CreateSupportPermit``."""
...
import capo_supportauthz.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_supportauthz.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_supportauthz.types.create_support_permit_output.CreateSupportPermitOutput = capo_supportauthz.types.create_support_permit_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/support-permits"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_supportauthz.types.create_support_permit_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_support_permit(
