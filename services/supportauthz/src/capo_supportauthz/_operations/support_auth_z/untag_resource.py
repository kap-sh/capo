"""Generated from Smithy shape ``com.amazonaws.supportauthz#UntagResource``."""
...
def handle_response(
    ...
    out: capo_supportauthz.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_supportauthz.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
