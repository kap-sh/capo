"""Generated from Smithy shape ``com.amazonaws.supportauthz#ListSupportPermitRequests``."""
...
def handle_response(
    ...
    out: capo_supportauthz.types.list_support_permit_requests_output.ListSupportPermitRequestsOutput = capo_supportauthz.types.list_support_permit_requests_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/support-permit-requests"
    params: list[tuple[str, str]] = []
    if "next_token" in input_:
        params.append(("nextToken", input_["next_token"]))
    if "max_results" in input_:
        params.append(("maxResults", str(input_["max_results"])))
    if "support_case_display_id" in input_:
        params.append(("supportCaseDisplayId", input_["support_case_display_id"]))
...
async def async_list_support_permit_requests(
