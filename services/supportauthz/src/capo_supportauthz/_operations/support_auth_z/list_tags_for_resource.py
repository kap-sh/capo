"""Generated from Smithy shape ``com.amazonaws.supportauthz#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_supportauthz.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_supportauthz.types.list_tags_for_resource_output.deserialize_json(
