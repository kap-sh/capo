"""Generated from Smithy shape ``com.amazonaws.supportauthz#GetSupportPermitOutput``."""
...
class GetSupportPermitOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetSupportPermitOutput) -> dict:
    out: dict = {}
    out["name"] = value["name"]
    out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GetSupportPermitOutput:
    out: GetSupportPermitOutput = {}  # type: ignore[typeddict-item]
    if data.get("name") is not None:
        out["name"] = data["name"]
    else:
        raise DeserializationError("GetSupportPermitOutput.name required")
    if data.get("arn") is not None:
        out["arn"] = data["arn"]
    else:
        raise DeserializationError("GetSupportPermitOutput.arn required")
    ...
    if data.get("permit") is not None:
        ...
        raise DeserializationError("GetSupportPermitOutput.permit required")
    if data.get("status") is not None:
        ...
        raise DeserializationError("GetSupportPermitOutput.status required")
    if data.get("signingKeyInfo") is not None:
        ...
        raise DeserializationError("GetSupportPermitOutput.signing_key_info required")
    if data.get("createdAt") is not None:
        ...
        raise DeserializationError("GetSupportPermitOutput.created_at required")
