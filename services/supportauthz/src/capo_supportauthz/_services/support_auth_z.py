...
from capo_supportauthz._services._aws_config import aws_config
...
class SupportAuthZClientConfig(TypedDict, total=False, closed=True):
...
class SupportAuthZClient:
    ...
    def __init__(
        ...
        self._config = SupportAuthZClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[SupportAuthZClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: SupportAuthZClientConfig = config_overrides or {}
    ...
    def create_support_permit(
        ...
        *,
        config_overrides: Optional[SupportAuthZClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.create_support_permit_input.CreateSupportPermitInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.create_support_permit_output.CreateSupportPermitOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.create_support_permit.create_support_permit(
    ...
    def delete_support_permit(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.delete_support_permit_input.DeleteSupportPermitInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.delete_support_permit_output.DeleteSupportPermitOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.delete_support_permit.delete_support_permit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_action(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.get_action_input.GetActionInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.get_action_output.GetActionOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.get_action.get_action(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_support_permit(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.get_support_permit_input.GetSupportPermitInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.get_support_permit_output.GetSupportPermitOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.get_support_permit.get_support_permit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_actions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.list_actions_input.ListActionsInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.list_actions_output.ListActionsOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.list_actions.list_actions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_actions(
        ...
        *,
        ...
        next_token: Optional["capo_supportauthz.types.next_token.NextToken"] = None,
        max_results: Optional["capo_supportauthz.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_supportauthz.types.action_summary.ActionSummary]":
        _token = next_token
        while True:
    ...
    def list_support_permit_requests(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.list_support_permit_requests_input.ListSupportPermitRequestsInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.list_support_permit_requests_output.ListSupportPermitRequestsOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.list_support_permit_requests.list_support_permit_requests(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_support_permit_requests(
        self,
        *,
        config_overrides: Optional[SupportAuthZClientConfig] = None,
        next_token: Optional["capo_supportauthz.types.next_token.NextToken"] = None,
        ...
        "Iterator[capo_supportauthz.types.support_permit_request.SupportPermitRequest]"
    ):
        _token = next_token
        while True:
            _response = self.list_support_permit_requests(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def list_support_permits(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.list_support_permits_input.ListSupportPermitsInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.list_support_permits_output.ListSupportPermitsOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.list_support_permits.list_support_permits(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_support_permits(
        ...
        *,
        ...
        "Iterator[capo_supportauthz.types.support_permit_summary.SupportPermitSummary]"
    ):
        _token = next_token
        while True:
            _response = self.list_support_permits(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reject_support_permit_request(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.reject_support_permit_request_input.RejectSupportPermitRequestInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.reject_support_permit_request_output.RejectSupportPermitRequestOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.reject_support_permit_request.reject_support_permit_request(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_supportauthz.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "capo_supportauthz.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_supportauthz._operations.support_auth_z.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
