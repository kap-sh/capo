"""Generated from Smithy shape ``com.amazonaws.supportauthz#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.supportauthz#ResourceNotFoundException``."""
