...
class GameLiftStreamsClient:
    ...
    def wait_until_application_deleted(
        self,
        identifier: "capo_gameliftstreams.types.identifier.Identifier",
        *,
        max_wait_time: float,
        ...
        while True:
            ...
            try:
                op_output = self.get_application(  # noqa: F841
    ...
    ) -> "Iterator[capo_gameliftstreams.types.application_summary.ApplicationSummary]":
        _token = next_token
        while True:
    ...
    def wait_until_stream_group_deleted(
        self,
        identifier: "capo_gameliftstreams.types.identifier.Identifier",
        *,
        max_wait_time: float,
        ...
        while True:
            ...
            op_error: ServiceError | None = None
            try:
                op_output = self.get_stream_group(  # noqa: F841
                    identifier, config_overrides=config_overrides
                )
            except ServiceError as e:
                op_error = e
    ...
    ) -> "Iterator[capo_gameliftstreams.types.stream_group_summary.StreamGroupSummary]":
        _token = next_token
        while True:
            _response = self.list_stream_groups(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
