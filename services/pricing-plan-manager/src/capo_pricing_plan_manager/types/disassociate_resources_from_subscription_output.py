"""Generated from Smithy shape ``com.amazonaws.pricingplanmanager#DisassociateResourcesFromSubscriptionOutput``."""
...
class DisassociateResourcesFromSubscriptionOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DisassociateResourcesFromSubscriptionOutput) -> dict:
    out: dict = {}
    import capo_pricing_plan_manager.types.subscription
...
def deserialize_json(data: dict) -> DisassociateResourcesFromSubscriptionOutput:
    out: DisassociateResourcesFromSubscriptionOutput = {}  # type: ignore[typeddict-item]
    if data.get("subscription") is not None:
        ...
        raise DeserializationError(
            "DisassociateResourcesFromSubscriptionOutput.subscription required"
        )
    return out
