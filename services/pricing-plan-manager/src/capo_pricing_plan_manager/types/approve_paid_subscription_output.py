"""Generated from Smithy shape ``com.amazonaws.pricingplanmanager#ApprovePaidSubscriptionOutput``."""
...
class ApprovePaidSubscriptionOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ApprovePaidSubscriptionOutput) -> dict:
    out: dict = {}
    import capo_pricing_plan_manager.types.subscription
...
def deserialize_json(data: dict) -> ApprovePaidSubscriptionOutput:
    out: ApprovePaidSubscriptionOutput = {}  # type: ignore[typeddict-item]
    if data.get("subscription") is not None:
        ...
        raise DeserializationError(
            "ApprovePaidSubscriptionOutput.subscription required"
        )
    return out
