"""Generated from Smithy shape ``com.amazonaws.pricingplanmanager#UpdateSubscriptionOutput``."""
...
class UpdateSubscriptionOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateSubscriptionOutput) -> dict:
    out: dict = {}
    import capo_pricing_plan_manager.types.subscription
...
def deserialize_json(data: dict) -> UpdateSubscriptionOutput:
    out: UpdateSubscriptionOutput = {}  # type: ignore[typeddict-item]
    if data.get("subscription") is not None:
        ...
        raise DeserializationError("UpdateSubscriptionOutput.subscription required")
    return out
