...
from capo_pricing_plan_manager._auth._identity import (
    Credentials,
    Identity,
)
...
# they need the `sso` extra: `pip install capo-pricing-plan-manager[sso]`. Without it the imports
...
def require_dependency(module: object | None, package: str) -> None:
    if module is None:
        raise MissingDependencyError(
            ...
            "installed; reinstall with the sso feature enabled: capo-pricing-plan-manager[sso]"
        )
