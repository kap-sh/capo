...
from capo_pricing_plan_manager._services._aws_config import aws_config
...
class PricingPlanManagerClientConfig(TypedDict, total=False, closed=True):
...
class PricingPlanManagerClient:
    ...
    def __init__(
        ...
        self._config = PricingPlanManagerClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[PricingPlanManagerClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: PricingPlanManagerClientConfig = config_overrides or {}
    ...
    def approve_paid_subscription(
        ...
        if_match: str,
        *,
        config_overrides: Optional[PricingPlanManagerClientConfig] = None,
        ...
        Examples:
            ...
            >>> client.approve_paid_subscription(arn='arn:aws:pricingplanmanager::123456789012:subscription/sub-1234567890', if_match='1')
        """

        def _handler(
            req: "OperationRequest[capo_pricing_plan_manager.types.approve_paid_subscription_input.ApprovePaidSubscriptionInput]",
        ) -> OperationResponse[
            "capo_pricing_plan_manager.types.approve_paid_subscription_output.ApprovePaidSubscriptionOutput"
        ]:
            ...
            output, http_response = (
                capo_pricing_plan_manager._operations.aws_pricing_plan_manager.approve_paid_subscription.approve_paid_subscription(
    ...
    def associate_resources_to_subscription(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.associate_resources_to_subscription(arn='arn:aws:pricingplanmanager::123456789012:subscription/sub-1234567890', resource_arns=['arn:aws:route53:::hostedzone/Z0123456789EXAMPLE'], if_match='1')
        """

        def _handler(
            req: "OperationRequest[capo_pricing_plan_manager.types.associate_resources_to_subscription_input.AssociateResourcesToSubscriptionInput]",
        ) -> OperationResponse[
            "capo_pricing_plan_manager.types.associate_resources_to_subscription_output.AssociateResourcesToSubscriptionOutput"
        ]:
            ...
            output, http_response = (
                capo_pricing_plan_manager._operations.aws_pricing_plan_manager.associate_resources_to_subscription.associate_resources_to_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def cancel_subscription(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.cancel_subscription(arn='arn:aws:pricingplanmanager::123456789012:subscription/sub-1234567890', if_match='2')
        """

        def _handler(
            req: "OperationRequest[capo_pricing_plan_manager.types.cancel_subscription_input.CancelSubscriptionInput]",
        ) -> OperationResponse[
            "capo_pricing_plan_manager.types.cancel_subscription_output.CancelSubscriptionOutput"
        ]:
            ...
            output, http_response = (
                capo_pricing_plan_manager._operations.aws_pricing_plan_manager.cancel_subscription.cancel_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def cancel_subscription_change(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.cancel_subscription_change(arn='arn:aws:pricingplanmanager::123456789012:subscription/sub-1234567890', if_match='3')
        """

        def _handler(
            req: "OperationRequest[capo_pricing_plan_manager.types.cancel_subscription_change_input.CancelSubscriptionChangeInput]",
        ) -> OperationResponse[
            "capo_pricing_plan_manager.types.cancel_subscription_change_output.CancelSubscriptionChangeOutput"
        ]:
            ...
            output, http_response = (
                capo_pricing_plan_manager._operations.aws_pricing_plan_manager.cancel_subscription_change.cancel_subscription_change(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_subscription(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_subscription(plan_family='CloudFront', plan_tier='PRO', resource_arns=['arn:aws:cloudfront::123456789012:distribution/EDFDVBD6EXAMPLE', 'arn:aws:wafv2:us-east-1:123456789012:global/webacl/ExampleWebACL/a1b2c3d4'], approval_mode='MANUAL')
            Create a subscription with approval mode

            >>> client.create_subscription(plan_family='CloudFront', plan_tier='PRO', resource_arns=['arn:aws:cloudfront::123456789012:distribution/EDFDVBD6EXAMPLE', 'arn:aws:wafv2:us-east-1:123456789012:global/webacl/ExampleWebACL/a1b2c3d4'], approval_mode='IMMEDIATE')
        """

        def _handler(
            req: "OperationRequest[capo_pricing_plan_manager.types.create_subscription_input.CreateSubscriptionInput]",
        ) -> OperationResponse[
            "capo_pricing_plan_manager.types.create_subscription_output.CreateSubscriptionOutput"
        ]:
            ...
            output, http_response = (
                capo_pricing_plan_manager._operations.aws_pricing_plan_manager.create_subscription.create_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_resources_from_subscription(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.disassociate_resources_from_subscription(arn='arn:aws:pricingplanmanager::123456789012:subscription/sub-1234567890', resource_arns=['arn:aws:route53:::hostedzone/Z0123456789EXAMPLE'], if_match='2')
        """

        def _handler(
            req: "OperationRequest[capo_pricing_plan_manager.types.disassociate_resources_from_subscription_input.DisassociateResourcesFromSubscriptionInput]",
        ) -> OperationResponse[
            "capo_pricing_plan_manager.types.disassociate_resources_from_subscription_output.DisassociateResourcesFromSubscriptionOutput"
        ]:
            ...
            output, http_response = (
                capo_pricing_plan_manager._operations.aws_pricing_plan_manager.disassociate_resources_from_subscription.disassociate_resources_from_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_subscription(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_subscription(arn='arn:aws:pricingplanmanager::123456789012:subscription/sub-1234567890')
        """

        def _handler(
            req: "OperationRequest[capo_pricing_plan_manager.types.get_subscription_input.GetSubscriptionInput]",
        ) -> OperationResponse[
            "capo_pricing_plan_manager.types.get_subscription_output.GetSubscriptionOutput"
        ]:
            ...
            output, http_response = (
                capo_pricing_plan_manager._operations.aws_pricing_plan_manager.get_subscription.get_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_subscriptions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_pricing_plan_manager.types.list_subscriptions_input.ListSubscriptionsInput]",
        ) -> OperationResponse[
            "capo_pricing_plan_manager.types.list_subscriptions_output.ListSubscriptionsOutput"
        ]:
            ...
            output, http_response = (
                capo_pricing_plan_manager._operations.aws_pricing_plan_manager.list_subscriptions.list_subscriptions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_subscriptions(
        ...
        *,
        config_overrides: Optional[PricingPlanManagerClientConfig] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_pricing_plan_manager.types.subscription_summary.SubscriptionSummary]":
        _token = next_token
        while True:
    ...
    def update_subscription(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_subscription(arn='arn:aws:pricingplanmanager::123456789012:subscription/sub-1234567890', plan_tier='BUSINESS', if_match='1')
        """

        def _handler(
            req: "OperationRequest[capo_pricing_plan_manager.types.update_subscription_input.UpdateSubscriptionInput]",
        ) -> OperationResponse[
            "capo_pricing_plan_manager.types.update_subscription_output.UpdateSubscriptionOutput"
        ]:
            ...
            output, http_response = (
                capo_pricing_plan_manager._operations.aws_pricing_plan_manager.update_subscription.update_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
