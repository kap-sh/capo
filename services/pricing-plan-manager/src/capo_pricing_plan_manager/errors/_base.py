...
class PricingPlanManagerError(Exception):
    """Base class for all PricingPlanManager service errors."""


class ServiceError(PricingPlanManagerError):
...
class SerializationError(PricingPlanManagerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PricingPlanManagerError):
...
class WaiterFailedError(PricingPlanManagerError):
...
class WaiterTimeoutError(PricingPlanManagerError):
