"""Generated from Smithy shape ``com.amazonaws.pricingplanmanager#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.pricingplanmanager#AccessDeniedException``."""
