...
class evsClient:
    ...
    ) -> "Iterator[capo_evs.types.environment_summary.EnvironmentSummary]":
        _token = next_token
        while True:
    ...
    def iter_list_environment_connectors(
        self,
        environment_id: "capo_evs.types.environment_id.EnvironmentId",
        *,
        config_overrides: Optional[evsClientConfig] = None,
        next_token: Optional["capo_evs.types.pagination_token.PaginationToken"] = None,
        max_results: Optional["capo_evs.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_evs.types.connector.Connector]":
        _token = next_token
        while True:
            _response = self.list_environment_connectors(
                environment_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_environment_hosts(
        self,
        environment_id: "capo_evs.types.environment_id.EnvironmentId",
        *,
        config_overrides: Optional[evsClientConfig] = None,
        next_token: Optional["capo_evs.types.pagination_token.PaginationToken"] = None,
        max_results: Optional["capo_evs.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_evs.types.host.Host]":
        _token = next_token
        while True:
            _response = self.list_environment_hosts(
                environment_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_environment_vlans(
        self,
        environment_id: "capo_evs.types.environment_id.EnvironmentId",
        *,
        config_overrides: Optional[evsClientConfig] = None,
        next_token: Optional["capo_evs.types.pagination_token.PaginationToken"] = None,
        max_results: Optional["capo_evs.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_evs.types.vlan.Vlan]":
        _token = next_token
        while True:
            _response = self.list_environment_vlans(
                environment_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_vm_entitlements(
        ...
        *,
        ...
        next_token: Optional["capo_evs.types.pagination_token.PaginationToken"] = None,
        max_results: Optional["capo_evs.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_evs.types.vm_entitlement.VmEntitlement]":
        _token = next_token
        while True:
            _response = self.list_vm_entitlements(
                environment_id,
                connector_id,
                entitlement_type,
                config_overrides=config_overrides,
