"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.networksecuritymanager#InternalServerException``."""
