...
class NetworkSecurityManagerError(Exception):
    """Base class for all NetworkSecurityManager service errors."""


class ServiceError(NetworkSecurityManagerError):
...
class SerializationError(NetworkSecurityManagerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(NetworkSecurityManagerError):
...
class WaiterFailedError(NetworkSecurityManagerError):
...
class WaiterTimeoutError(NetworkSecurityManagerError):
