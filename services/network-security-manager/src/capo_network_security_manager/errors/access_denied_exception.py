"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.networksecuritymanager#AccessDeniedException``."""
