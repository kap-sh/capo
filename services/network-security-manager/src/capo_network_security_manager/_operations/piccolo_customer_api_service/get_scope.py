"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetScope``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.get_scope_output.GetScopeOutput = (
        capo_network_security_manager.types.get_scope_output.deserialize_json(
...
def get_scope(
    ...
    capo_network_security_manager.types.get_scope_output.GetScopeOutput, zapros.Response
]:
