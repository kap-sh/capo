"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListScopes``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_scopes_output.ListScopesOutput = (
        capo_network_security_manager.types.list_scopes_output.deserialize_json(
