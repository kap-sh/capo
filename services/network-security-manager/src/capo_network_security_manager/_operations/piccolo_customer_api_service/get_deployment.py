"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetDeployment``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.get_deployment_output.GetDeploymentOutput = capo_network_security_manager.types.get_deployment_output.deserialize_json(
