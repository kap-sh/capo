"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#UpdateTemplate``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.update_template_output.UpdateTemplateOutput = capo_network_security_manager.types.update_template_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/templates/{templateIdentifier}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.update_template_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
