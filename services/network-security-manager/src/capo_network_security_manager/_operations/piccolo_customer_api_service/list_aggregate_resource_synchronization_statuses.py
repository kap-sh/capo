"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListAggregateResourceSynchronizationStatuses``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_aggregate_resource_synchronization_statuses_output.ListAggregateResourceSynchronizationStatusesOutput = capo_network_security_manager.types.list_aggregate_resource_synchronization_statuses_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/aggregate-sync-statuses"
...
async def async_list_aggregate_resource_synchronization_statuses(
