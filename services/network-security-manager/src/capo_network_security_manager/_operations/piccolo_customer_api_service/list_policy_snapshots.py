"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListPolicySnapshots``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_policy_snapshots_output.ListPolicySnapshotsOutput = capo_network_security_manager.types.list_policy_snapshots_output.deserialize_json(
...
async def async_list_policy_snapshots(
