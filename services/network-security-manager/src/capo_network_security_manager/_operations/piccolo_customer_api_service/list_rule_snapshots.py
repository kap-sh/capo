"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListRuleSnapshots``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_rule_snapshots_output.ListRuleSnapshotsOutput = capo_network_security_manager.types.list_rule_snapshots_output.deserialize_json(
...
async def async_list_rule_snapshots(
