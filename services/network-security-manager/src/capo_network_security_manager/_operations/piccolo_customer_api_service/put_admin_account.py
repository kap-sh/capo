"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#PutAdminAccount``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.put_admin_account_response.PutAdminAccountResponse = capo_network_security_manager.types.put_admin_account_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/admin-account"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.put_admin_account_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
