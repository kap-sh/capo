"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreateDeploymentSnapshot``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.create_deployment_snapshot_output.CreateDeploymentSnapshotOutput = capo_network_security_manager.types.create_deployment_snapshot_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.create_deployment_snapshot_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_deployment_snapshot(
