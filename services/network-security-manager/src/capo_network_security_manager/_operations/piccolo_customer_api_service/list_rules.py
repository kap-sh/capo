"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListRules``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_rules_output.ListRulesOutput = (
        capo_network_security_manager.types.list_rules_output.deserialize_json(
