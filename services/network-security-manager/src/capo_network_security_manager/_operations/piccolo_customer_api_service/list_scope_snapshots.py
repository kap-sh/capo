"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListScopeSnapshots``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_scope_snapshots_output.ListScopeSnapshotsOutput = capo_network_security_manager.types.list_scope_snapshots_output.deserialize_json(
...
async def async_list_scope_snapshots(
