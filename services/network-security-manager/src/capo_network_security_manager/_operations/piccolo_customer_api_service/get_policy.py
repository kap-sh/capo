"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetPolicy``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.get_policy_output.GetPolicyOutput = (
        capo_network_security_manager.types.get_policy_output.deserialize_json(
