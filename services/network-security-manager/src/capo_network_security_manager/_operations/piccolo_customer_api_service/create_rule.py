"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreateRule``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.create_rule_output.CreateRuleOutput = (
        capo_network_security_manager.types.create_rule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.create_rule_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
