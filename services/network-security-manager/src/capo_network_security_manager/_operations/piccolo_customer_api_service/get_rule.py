"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetRule``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.get_rule_output.GetRuleOutput = (
        capo_network_security_manager.types.get_rule_output.deserialize_json(
...
def get_rule(
    ...
    capo_network_security_manager.types.get_rule_output.GetRuleOutput, zapros.Response
]:
