"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListResourceAssociations``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_resource_associations_output.ListResourceAssociationsOutput = capo_network_security_manager.types.list_resource_associations_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/resource-associations"
...
async def async_list_resource_associations(
