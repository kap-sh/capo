"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetAdminAccount``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.get_admin_account_response.GetAdminAccountResponse = capo_network_security_manager.types.get_admin_account_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/admin-account/{accountId}"
