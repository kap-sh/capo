"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListTemplates``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_templates_output.ListTemplatesOutput = capo_network_security_manager.types.list_templates_output.deserialize_json(
