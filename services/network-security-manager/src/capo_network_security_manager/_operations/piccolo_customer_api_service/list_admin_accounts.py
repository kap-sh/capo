"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListAdminAccounts``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_admin_accounts_response.ListAdminAccountsResponse = capo_network_security_manager.types.list_admin_accounts_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/admin-accounts"
...
async def async_list_admin_accounts(
