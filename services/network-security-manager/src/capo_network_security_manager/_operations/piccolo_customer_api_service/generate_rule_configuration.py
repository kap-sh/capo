"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GenerateRuleConfiguration``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.generate_rule_configuration_response.GenerateRuleConfigurationResponse = capo_network_security_manager.types.generate_rule_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GenerateRuleConfiguration"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.generate_rule_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_generate_rule_configuration(
