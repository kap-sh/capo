"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListTemplateSnapshots``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_template_snapshots_output.ListTemplateSnapshotsOutput = capo_network_security_manager.types.list_template_snapshots_output.deserialize_json(
...
async def async_list_template_snapshots(
