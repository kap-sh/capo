"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#TagResource``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.tag_resource_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
