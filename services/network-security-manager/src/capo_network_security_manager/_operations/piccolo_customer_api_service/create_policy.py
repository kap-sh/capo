"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreatePolicy``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.create_policy_output.CreatePolicyOutput = (
        capo_network_security_manager.types.create_policy_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.create_policy_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
