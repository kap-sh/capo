"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreateScope``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.create_scope_output.CreateScopeOutput = (
        capo_network_security_manager.types.create_scope_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.create_scope_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
