"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetTemplate``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.get_template_output.GetTemplateOutput = (
        capo_network_security_manager.types.get_template_output.deserialize_json(
