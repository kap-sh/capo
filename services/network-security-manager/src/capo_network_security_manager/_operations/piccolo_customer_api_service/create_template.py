"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreateTemplate``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.create_template_output.CreateTemplateOutput = capo_network_security_manager.types.create_template_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.create_template_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
