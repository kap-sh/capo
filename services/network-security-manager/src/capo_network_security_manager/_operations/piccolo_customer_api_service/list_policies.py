"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListPolicies``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_policies_output.ListPoliciesOutput = (
        capo_network_security_manager.types.list_policies_output.deserialize_json(
