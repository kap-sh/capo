"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#UpdateDeployment``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.update_deployment_output.UpdateDeploymentOutput = capo_network_security_manager.types.update_deployment_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_security_manager.types.update_deployment_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
