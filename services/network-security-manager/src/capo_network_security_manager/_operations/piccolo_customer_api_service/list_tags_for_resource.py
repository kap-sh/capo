"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_network_security_manager.types.list_tags_for_resource_output.deserialize_json(
