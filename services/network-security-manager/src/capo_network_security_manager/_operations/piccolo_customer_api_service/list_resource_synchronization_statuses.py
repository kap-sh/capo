"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListResourceSynchronizationStatuses``."""
...
def handle_response(
    ...
    out: capo_network_security_manager.types.list_resource_synchronization_statuses_output.ListResourceSynchronizationStatusesOutput = capo_network_security_manager.types.list_resource_synchronization_statuses_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/resource-sync-statuses"
    params: list[tuple[str, str]] = []
    if "deployment_identifier" in input_:
        params.append(("deploymentIdentifier", input_["deployment_identifier"]))
    if "synchronization_status" in input_:
        params.append(
            (
                "synchronizationStatus",
                capo_network_security_manager.types.synchronization_status.serialize_json(
                    input_["synchronization_status"]
                ),
            )
        )
...
async def async_list_resource_synchronization_statuses(
