"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetTemplateOutput``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: GetTemplateOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetTemplateOutput:
    out: GetTemplateOutput = {}  # type: ignore[typeddict-item]
    if data.get("templateId") is not None:
        out["template_id"] = data["templateId"]
    else:
        raise DeserializationError("GetTemplateOutput.template_id required")
    if data.get("templateArn") is not None:
        out["template_arn"] = data["templateArn"]
    else:
        raise DeserializationError("GetTemplateOutput.template_arn required")
    if data.get("templateName") is not None:
        out["template_name"] = data["templateName"]
    else:
        raise DeserializationError("GetTemplateOutput.template_name required")
    ...
    if data.get("status") is not None:
        ...
        raise DeserializationError("GetTemplateOutput.status required")
    if data.get("version") is not None:
        out["version"] = data["version"]
    else:
        raise DeserializationError("GetTemplateOutput.version required")
    if data.get("associatedRuleList") is not None:
        ...
        raise DeserializationError("GetTemplateOutput.associated_rule_list required")
    ...
    if data.get("firewallType") is not None:
        ...
        raise DeserializationError("GetTemplateOutput.firewall_type required")
