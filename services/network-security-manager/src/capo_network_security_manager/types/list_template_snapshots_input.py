"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListTemplateSnapshotsInput``."""
...
class ListTemplateSnapshotsInput(TypedDict, closed=True):
    template_identifier: (
...
# --- restJson1 ser/de ---
def serialize_json(value: ListTemplateSnapshotsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListTemplateSnapshotsInput:
    out: ListTemplateSnapshotsInput = {}  # type: ignore[typeddict-item]
    return out
