"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreatePolicySnapshotOutput``."""
...
class CreatePolicySnapshotOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreatePolicySnapshotOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreatePolicySnapshotOutput:
    out: CreatePolicySnapshotOutput = {}  # type: ignore[typeddict-item]
    if data.get("policyId") is not None:
        out["policy_id"] = data["policyId"]
    else:
        raise DeserializationError("CreatePolicySnapshotOutput.policy_id required")
    if data.get("policyArn") is not None:
        out["policy_arn"] = data["policyArn"]
    else:
        raise DeserializationError("CreatePolicySnapshotOutput.policy_arn required")
    if data.get("policyName") is not None:
        out["policy_name"] = data["policyName"]
    else:
        raise DeserializationError("CreatePolicySnapshotOutput.policy_name required")
    ...
    if data.get("status") is not None:
        ...
        raise DeserializationError("CreatePolicySnapshotOutput.status required")
    if data.get("priority") is not None:
        out["priority"] = data["priority"]
    else:
        raise DeserializationError("CreatePolicySnapshotOutput.priority required")
    if data.get("associatedTemplateAndRuleList") is not None:
        ...
        raise DeserializationError(
            "CreatePolicySnapshotOutput.associated_template_and_rule_list required"
        )
    if data.get("version") is not None:
        out["version"] = data["version"]
    else:
        raise DeserializationError("CreatePolicySnapshotOutput.version required")
    ...
    if data.get("firewallType") is not None:
        ...
        raise DeserializationError("CreatePolicySnapshotOutput.firewall_type required")
