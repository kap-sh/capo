"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreateRuleOutput``."""
...
def deserialize_json(data: dict) -> CreateRuleOutput:
    ...
    if data.get("ruleId") is not None:
        ...
        raise DeserializationError("CreateRuleOutput.rule_id required")
    if data.get("ruleArn") is not None:
        out["rule_arn"] = data["ruleArn"]
    else:
        raise DeserializationError("CreateRuleOutput.rule_arn required")
    if data.get("ruleName") is not None:
        out["rule_name"] = data["ruleName"]
    else:
        raise DeserializationError("CreateRuleOutput.rule_name required")
    if data.get("firewallType") is not None:
        ...
        raise DeserializationError("CreateRuleOutput.firewall_type required")
    ...
    if data.get("configuration") is not None:
        ...
        raise DeserializationError("CreateRuleOutput.configuration required")
    if data.get("status") is not None:
        ...
        raise DeserializationError("CreateRuleOutput.status required")
    if data.get("version") is not None:
        out["version"] = data["version"]
    else:
        raise DeserializationError("CreateRuleOutput.version required")
