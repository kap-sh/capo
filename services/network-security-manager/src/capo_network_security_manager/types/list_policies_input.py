"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListPoliciesInput``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: ListPoliciesInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListPoliciesInput:
