"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreatePolicySnapshotInput``."""
...
class CreatePolicySnapshotInput(TypedDict, closed=True):
    policy_identifier: (
...
# --- restJson1 ser/de ---
def serialize_json(value: CreatePolicySnapshotInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreatePolicySnapshotInput:
    out: CreatePolicySnapshotInput = {}  # type: ignore[typeddict-item]
