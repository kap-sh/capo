"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListAggregateResourceSynchronizationStatusesOutput``."""
...
class ListAggregateResourceSynchronizationStatusesOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAggregateResourceSynchronizationStatusesOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListAggregateResourceSynchronizationStatusesOutput:
    out: ListAggregateResourceSynchronizationStatusesOutput = {}  # type: ignore[typeddict-item]
    ...
    if data.get("resourceSynchronizationStatuses") is not None:
        ...
        raise DeserializationError(
            "ListAggregateResourceSynchronizationStatusesOutput.resource_synchronization_statuses required"
        )
    return out
