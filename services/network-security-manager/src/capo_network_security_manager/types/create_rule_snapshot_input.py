"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreateRuleSnapshotInput``."""
...
class CreateRuleSnapshotInput(TypedDict, closed=True):
    rule_identifier: (
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateRuleSnapshotInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateRuleSnapshotInput:
    out: CreateRuleSnapshotInput = {}  # type: ignore[typeddict-item]
