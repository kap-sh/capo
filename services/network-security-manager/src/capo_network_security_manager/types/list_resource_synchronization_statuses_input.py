"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListResourceSynchronizationStatusesInput``."""
...
class ListResourceSynchronizationStatusesInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListResourceSynchronizationStatusesInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListResourceSynchronizationStatusesInput:
    out: ListResourceSynchronizationStatusesInput = {}  # type: ignore[typeddict-item]
    return out
