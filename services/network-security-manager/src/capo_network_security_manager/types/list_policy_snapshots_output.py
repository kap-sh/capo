"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListPolicySnapshotsOutput``."""
...
class ListPolicySnapshotsOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListPolicySnapshotsOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListPolicySnapshotsOutput:
    out: ListPolicySnapshotsOutput = {}  # type: ignore[typeddict-item]
    ...
    if data.get("snapshots") is not None:
        ...
        raise DeserializationError("ListPolicySnapshotsOutput.snapshots required")
    return out
