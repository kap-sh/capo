"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListAggregateResourceSynchronizationStatusesInput``."""
...
class ListAggregateResourceSynchronizationStatusesInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListAggregateResourceSynchronizationStatusesInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListAggregateResourceSynchronizationStatusesInput:
    out: ListAggregateResourceSynchronizationStatusesInput = {}  # type: ignore[typeddict-item]
    return out
