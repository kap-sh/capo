"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreateScopeSnapshotInput``."""
...
class CreateScopeSnapshotInput(TypedDict, closed=True):
    scope_identifier: (
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateScopeSnapshotInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateScopeSnapshotInput:
    out: CreateScopeSnapshotInput = {}  # type: ignore[typeddict-item]
