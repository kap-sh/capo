"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetRuleOutput``."""
...
def deserialize_json(data: dict) -> GetRuleOutput:
    ...
    if data.get("ruleId") is not None:
        ...
        raise DeserializationError("GetRuleOutput.rule_id required")
    if data.get("ruleArn") is not None:
        out["rule_arn"] = data["ruleArn"]
    else:
        raise DeserializationError("GetRuleOutput.rule_arn required")
    if data.get("ruleName") is not None:
        out["rule_name"] = data["ruleName"]
    else:
        raise DeserializationError("GetRuleOutput.rule_name required")
    if data.get("firewallType") is not None:
        ...
        raise DeserializationError("GetRuleOutput.firewall_type required")
    ...
    if data.get("configuration") is not None:
        ...
        raise DeserializationError("GetRuleOutput.configuration required")
    if data.get("status") is not None:
        ...
        raise DeserializationError("GetRuleOutput.status required")
    if data.get("version") is not None:
        out["version"] = data["version"]
    else:
        raise DeserializationError("GetRuleOutput.version required")
