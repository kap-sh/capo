"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetScopeOutput``."""
...
def deserialize_json(data: dict) -> GetScopeOutput:
    ...
    if data.get("scopeName") is not None:
        ...
        raise DeserializationError("GetScopeOutput.scope_name required")
    ...
    if data.get("version") is not None:
        ...
        raise DeserializationError("GetScopeOutput.version required")
