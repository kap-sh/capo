"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#GetPolicyOutput``."""
...
def deserialize_json(data: dict) -> GetPolicyOutput:
    ...
    if data.get("policyArn") is not None:
        ...
        raise DeserializationError("GetPolicyOutput.policy_arn required")
    if data.get("policyName") is not None:
        out["policy_name"] = data["policyName"]
    else:
        raise DeserializationError("GetPolicyOutput.policy_name required")
    ...
    if data.get("status") is not None:
        ...
        raise DeserializationError("GetPolicyOutput.status required")
    if data.get("priority") is not None:
        out["priority"] = data["priority"]
    else:
        raise DeserializationError("GetPolicyOutput.priority required")
    if data.get("associatedTemplateAndRuleList") is not None:
        ...
        raise DeserializationError(
            "GetPolicyOutput.associated_template_and_rule_list required"
        )
    if data.get("version") is not None:
        out["version"] = data["version"]
    else:
        raise DeserializationError("GetPolicyOutput.version required")
    ...
    if data.get("firewallType") is not None:
        ...
        raise DeserializationError("GetPolicyOutput.firewall_type required")
