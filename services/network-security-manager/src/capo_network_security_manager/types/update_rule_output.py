"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#UpdateRuleOutput``."""
...
def deserialize_json(data: dict) -> UpdateRuleOutput:
    ...
    if data.get("ruleId") is not None:
        ...
        raise DeserializationError("UpdateRuleOutput.rule_id required")
    if data.get("ruleArn") is not None:
        out["rule_arn"] = data["ruleArn"]
    else:
        raise DeserializationError("UpdateRuleOutput.rule_arn required")
    if data.get("ruleName") is not None:
        out["rule_name"] = data["ruleName"]
    else:
        raise DeserializationError("UpdateRuleOutput.rule_name required")
    if data.get("firewallType") is not None:
        ...
        raise DeserializationError("UpdateRuleOutput.firewall_type required")
    ...
    if data.get("configuration") is not None:
        ...
        raise DeserializationError("UpdateRuleOutput.configuration required")
    if data.get("status") is not None:
        ...
        raise DeserializationError("UpdateRuleOutput.status required")
    if data.get("version") is not None:
        out["version"] = data["version"]
    else:
        raise DeserializationError("UpdateRuleOutput.version required")
