"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#UpdateTemplateOutput``."""
...
class UpdateTemplateOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateTemplateOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateTemplateOutput:
    out: UpdateTemplateOutput = {}  # type: ignore[typeddict-item]
    if data.get("templateId") is not None:
        out["template_id"] = data["templateId"]
    else:
        raise DeserializationError("UpdateTemplateOutput.template_id required")
    if data.get("templateArn") is not None:
        out["template_arn"] = data["templateArn"]
    else:
        raise DeserializationError("UpdateTemplateOutput.template_arn required")
    if data.get("templateName") is not None:
        out["template_name"] = data["templateName"]
    else:
        raise DeserializationError("UpdateTemplateOutput.template_name required")
    ...
    if data.get("status") is not None:
        ...
        raise DeserializationError("UpdateTemplateOutput.status required")
    if data.get("version") is not None:
        out["version"] = data["version"]
    else:
        raise DeserializationError("UpdateTemplateOutput.version required")
    if data.get("associatedRuleList") is not None:
        ...
        raise DeserializationError("UpdateTemplateOutput.associated_rule_list required")
    ...
    if data.get("firewallType") is not None:
        ...
        raise DeserializationError("UpdateTemplateOutput.firewall_type required")
