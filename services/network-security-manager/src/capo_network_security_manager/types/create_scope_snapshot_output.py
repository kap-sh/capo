"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreateScopeSnapshotOutput``."""
...
class CreateScopeSnapshotOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateScopeSnapshotOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateScopeSnapshotOutput:
    out: CreateScopeSnapshotOutput = {}  # type: ignore[typeddict-item]
    if data.get("scopeId") is not None:
        out["scope_id"] = data["scopeId"]
    else:
        raise DeserializationError("CreateScopeSnapshotOutput.scope_id required")
    if data.get("scopeArn") is not None:
        out["scope_arn"] = data["scopeArn"]
    else:
        raise DeserializationError("CreateScopeSnapshotOutput.scope_arn required")
    if data.get("scopeName") is not None:
        out["scope_name"] = data["scopeName"]
    else:
        raise DeserializationError("CreateScopeSnapshotOutput.scope_name required")
    ...
    if data.get("status") is not None:
        ...
        raise DeserializationError("CreateScopeSnapshotOutput.status required")
    if data.get("version") is not None:
        out["version"] = data["version"]
    else:
        raise DeserializationError("CreateScopeSnapshotOutput.version required")
