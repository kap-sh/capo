"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#ListScopeSnapshotsInput``."""
...
class ListScopeSnapshotsInput(TypedDict, closed=True):
    scope_identifier: (
...
# --- restJson1 ser/de ---
def serialize_json(value: ListScopeSnapshotsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListScopeSnapshotsInput:
    out: ListScopeSnapshotsInput = {}  # type: ignore[typeddict-item]
    return out
