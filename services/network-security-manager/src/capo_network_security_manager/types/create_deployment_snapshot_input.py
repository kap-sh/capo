"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#CreateDeploymentSnapshotInput``."""
...
class CreateDeploymentSnapshotInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateDeploymentSnapshotInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateDeploymentSnapshotInput:
    out: CreateDeploymentSnapshotInput = {}  # type: ignore[typeddict-item]
