"""Generated from Smithy shape ``com.amazonaws.networksecuritymanager#UpdateScopeOutput``."""
...
def deserialize_json(data: dict) -> UpdateScopeOutput:
    ...
    if data.get("scopeName") is not None:
        ...
        raise DeserializationError("UpdateScopeOutput.scope_name required")
    ...
    if data.get("version") is not None:
        ...
        raise DeserializationError("UpdateScopeOutput.version required")
