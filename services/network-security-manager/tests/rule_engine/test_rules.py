import pytest
from capo_network_security_manager._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_network_security_manager._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://network-security-manager-fips.us-east-1.api.aws'

def test_for_region_us_east_1_with_fips_disabled_():
    """For region us-east-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False)
    result = resolve(params)
    assert result.url == 'https://network-security-manager.us-east-1.api.aws'
...
def test_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://network-security-manager-fips.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://network-security-manager.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://network-security-manager-fips.us-gov-west-1.api.aws'
...
def test_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://network-security-manager.us-gov-west-1.api.aws'
