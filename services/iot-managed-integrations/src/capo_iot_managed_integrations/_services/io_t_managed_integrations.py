...
class IoTManagedIntegrationsClient:
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.account_association_item.AccountAssociationItem]":
        _token = next_token
        while True:
    ...
    def create_cloud_connector(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_cloud_connector(name='Connector for TP Link Cloud', endpoint_type='LAMBDA', endpoint_config={'lambda': {'arn': 'arn:aws:lambda:us-east-1:111122223333:function:my-function:myVersion'}}, client_token='1234567890')
            CreateCloudConnector happy path for Ring

            >>> client.create_cloud_connector(name='Connector for Ring Cloud', endpoint_type='LAMBDA', endpoint_config={'lambda': {'arn': 'arn:aws:lambda:us-east-1:111122223333:function:my-function:myVersion'}}, client_token='12312321')
            CreateCloudConnector error path for Ring connector which already exists

            >>> client.create_cloud_connector(name='Connector for Ring Cloud', endpoint_type='LAMBDA', endpoint_config={'lambda': {'arn': 'arn:aws:lambda:us-east-1:111122223333:function:my-function:myVersion2'}}, client_token='1213123123')
        """
    ...
    def get_cloud_connector(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_cloud_connector(identifier='123456789012')
    ...
    def update_cloud_connector(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_cloud_connector(identifier='123456789012', name='Connector for TP Link Cloud V2')
            UpdateCloudConnector error Id for Ring connector which does not exist

            >>> client.update_cloud_connector(identifier='123456789012', name='Connector for Ring Cloud')
        """
    ...
    def list_cloud_connectors(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_cloud_connectors(max_results=5)
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.connector_item.ConnectorItem]":
        _token = next_token
        while True:
    ...
    def iter_list_connector_destinations(
        self,
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
        cloud_connector_id: Optional[
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.connector_destination_summary.ConnectorDestinationSummary]":
        _token = next_token
        while True:
            _response = self.list_connector_destinations(
                config_overrides=config_overrides,
                cloud_connector_id=cloud_connector_id,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_credential_lockers(
        self,
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
        next_token: Optional[
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.credential_locker_summary.CredentialLockerSummary]":
        _token = next_token
        while True:
            _response = self.list_credential_lockers(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.destination_summary.DestinationSummary]":
        _token = next_token
        while True:
    ...
    def iter_list_device_discoveries(
        self,
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
        next_token: Optional[
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.device_discovery_summary.DeviceDiscoverySummary]":
        _token = next_token
        while True:
            _response = self.list_device_discoveries(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_discovered_devices(
        self,
        identifier: "capo_iot_managed_integrations.types.device_discovery_id.DeviceDiscoveryId",
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.discovered_device_summary.DiscoveredDeviceSummary]":
        _token = next_token
        while True:
            _response = self.list_discovered_devices(
                identifier,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_event_log_configurations(
        self,
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
        next_token: Optional[
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.event_log_configuration_summary.EventLogConfigurationSummary]":
        _token = next_token
        while True:
            _response = self.list_event_log_configurations(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def iter_list_managed_thing_account_associations(
        self,
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
        managed_thing_id: Optional[
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.managed_thing_association.ManagedThingAssociation]":
        _token = next_token
        while True:
            _response = self.list_managed_thing_account_associations(
                config_overrides=config_overrides,
                managed_thing_id=managed_thing_id,
                account_association_id=account_association_id,
                max_results=max_results,
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.managed_thing_summary.ManagedThingSummary]":
        _token = next_token
        while True:
            _response = self.list_managed_things(
                config_overrides=config_overrides,
    ...
    def iter_list_managed_thing_schemas(
        self,
        identifier: "capo_iot_managed_integrations.types.managed_thing_id.ManagedThingId",
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.managed_thing_schema_list_item.ManagedThingSchemaListItem]":
        _token = next_token
        while True:
            _response = self.list_managed_thing_schemas(
                identifier,
                config_overrides=config_overrides,
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.notification_configuration_summary.NotificationConfigurationSummary]":
        _token = next_token
        while True:
    ...
    def iter_list_ota_task_configurations(
        self,
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
        next_token: Optional[
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.ota_task_configuration_summary.OtaTaskConfigurationSummary]":
        _token = next_token
        while True:
            _response = self.list_ota_task_configurations(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def iter_list_ota_tasks(
        ...
        *,
        ...
        "Iterator[capo_iot_managed_integrations.types.ota_task_summary.OtaTaskSummary]"
    ):
        _token = next_token
        while True:
            _response = self.list_ota_tasks(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def iter_list_ota_task_executions(
        self,
        identifier: "capo_iot_managed_integrations.types.ota_task_id.OtaTaskId",
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.ota_task_execution_summaries.OtaTaskExecutionSummaries]":
        _token = next_token
        while True:
            _response = self.list_ota_task_executions(
                identifier,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_provisioning_profiles(
        self,
        *,
        config_overrides: Optional[IoTManagedIntegrationsClientConfig] = None,
        next_token: Optional[
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.provisioning_profile_summary.ProvisioningProfileSummary]":
        _token = next_token
        while True:
            _response = self.list_provisioning_profiles(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def get_schema_version(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.get_schema_version(schema_versioned_id='matter.ColorControl@1.4', type='capability')
            GetSchemaVersion happy path for an example schema version.

            >>> client.get_schema_version(schema_versioned_id='matter.ColorControl@1.4', type='capability', format='ZCL')
            GetSchemaVersion error path for an example schema version that does not exist.

            >>> client.get_schema_version(schema_versioned_id='matter.ColorControl@$latest', type='capability')
        """
    ...
    def list_schema_versions(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_schema_versions(schema_id='example.ColorControl', type='capability')
            ListSchemaVersions by version.

            >>> client.list_schema_versions(type='capability', semantic_version='34.56')
            ListSchemaVersions error  for invalid input.

            >>> client.list_schema_versions(schema_id='example.ColorControl', type='capability', namespace='matter')
        """
    ...
    ) -> "Iterator[capo_iot_managed_integrations.types.schema_version_list_item.SchemaVersionListItem]":
        _token = next_token
        while True:
