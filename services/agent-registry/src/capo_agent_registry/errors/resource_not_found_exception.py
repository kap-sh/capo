"""Generated from Smithy shape ``com.amazonaws.agentregistry#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.agentregistry#ResourceNotFoundException``."""
