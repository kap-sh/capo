"""Generated from Smithy shape ``com.amazonaws.agentregistry#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.agentregistry#InternalServerException``."""
