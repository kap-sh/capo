"""Generated from Smithy shape ``com.amazonaws.agentregistry#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.agentregistry#ThrottlingException``."""
