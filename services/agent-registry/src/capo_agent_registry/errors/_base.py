...
class AgentRegistryError(Exception):
    """Base class for all AgentRegistry service errors."""


class ServiceError(AgentRegistryError):
...
class DeserializationError(AgentRegistryError):
...
class WaiterFailedError(AgentRegistryError):
...
class WaiterTimeoutError(AgentRegistryError):
