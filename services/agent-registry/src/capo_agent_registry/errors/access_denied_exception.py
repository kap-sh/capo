"""Generated from Smithy shape ``com.amazonaws.agentregistry#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.agentregistry#AccessDeniedException``."""
