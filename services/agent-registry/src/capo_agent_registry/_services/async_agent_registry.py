...
from capo_agent_registry._services._aws_config import aaws_config
...
class AsyncAgentRegistryClientConfig(TypedDict, total=False, closed=True):
...
class AsyncAgentRegistryClient:
    ...
    def __init__(
        ...
        self._config = AsyncAgentRegistryClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncAgentRegistryClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncAgentRegistryClientConfig = config_overrides or {}
    ...
    async def batch_get_discoverable_registry_record(
        ...
        *,
        config_overrides: Optional[AsyncAgentRegistryClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_agent_registry.types.batch_get_discoverable_registry_record_request.BatchGetDiscoverableRegistryRecordRequest]",
        ) -> AsyncOperationResponse[
            "capo_agent_registry.types.batch_get_discoverable_registry_record_response.BatchGetDiscoverableRegistryRecordResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_agent_registry._operations.agent_registry.batch_get_discoverable_registry_record.async_batch_get_discoverable_registry_record(
    ...
    async def list_discoverable_registry_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_agent_registry.types.list_discoverable_registry_records_request.ListDiscoverableRegistryRecordsRequest]",
        ) -> AsyncOperationResponse[
            "capo_agent_registry.types.list_discoverable_registry_records_response.ListDiscoverableRegistryRecordsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_agent_registry._operations.agent_registry.list_discoverable_registry_records.async_list_discoverable_registry_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_discoverable_registry_records(
        self,
        registry_id: "capo_agent_registry.types.registry_identifier.RegistryIdentifier",
        *,
        config_overrides: Optional[AsyncAgentRegistryClientConfig] = None,
    ...
    ) -> "AsyncIterator[capo_agent_registry.types.discoverable_registry_record_summary.DiscoverableRegistryRecordSummary]":
        _token = next_token
        while True:
            _response = await self.list_discoverable_registry_records(
                registry_id,
    ...
    async def search_discoverable_registry_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_agent_registry.types.search_discoverable_registry_records_request.SearchDiscoverableRegistryRecordsRequest]",
        ) -> AsyncOperationResponse[
            "capo_agent_registry.types.search_discoverable_registry_records_response.SearchDiscoverableRegistryRecordsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_agent_registry._operations.agent_registry.search_discoverable_registry_records.async_search_discoverable_registry_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
