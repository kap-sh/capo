...
from ._services.agent_registry import AgentRegistryClient as AgentRegistryClient
from ._services.async_agent_registry import (
    AsyncAgentRegistryClient as AsyncAgentRegistryClient,
)
