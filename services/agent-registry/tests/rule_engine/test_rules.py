...
from capo_agent_registry._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_region_us_west_2____region_based_prod_ho():
    ...
    assert result.url == 'https://agent-registry.us-west-2.api.aws'
...
def test_region_us_east_1____region_based_prod_ho():
    ...
    result = resolve(params)
    assert result.url == 'https://agent-registry.us-east-1.api.aws'
