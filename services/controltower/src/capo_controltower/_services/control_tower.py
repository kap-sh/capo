...
class ControlTowerClient:
    ...
    ) -> "Iterator[capo_controltower.types.baseline_summary.BaselineSummary]":
        _token = next_token
        while True:
            _response = self.list_baselines(
    ...
    def iter_list_control_operations(
        self,
        *,
        config_overrides: Optional[ControlTowerClientConfig] = None,
        filter: Optional[
    ...
    ) -> "Iterator[capo_controltower.types.control_operation_summary.ControlOperationSummary]":
        _token = next_token
        while True:
            _response = self.list_control_operations(
                config_overrides=config_overrides,
                filter=filter,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_enabled_baselines(
        self,
        *,
        config_overrides: Optional[ControlTowerClientConfig] = None,
        filter: Optional[
        ...
        include_children: Optional[bool] = None,
    ) -> "Iterator[capo_controltower.types.enabled_baseline_summary.EnabledBaselineSummary]":
        _token = next_token
        while True:
            _response = self.list_enabled_baselines(
                config_overrides=config_overrides,
                filter=filter,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_enabled_controls(
        self,
        *,
        config_overrides: Optional[ControlTowerClientConfig] = None,
        target_identifier: Optional[
        ...
        include_children: Optional[bool] = None,
    ) -> "Iterator[capo_controltower.types.enabled_control_summary.EnabledControlSummary]":
        _token = next_token
        while True:
            _response = self.list_enabled_controls(
                config_overrides=config_overrides,
                target_identifier=target_identifier,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_landing_zone_operations(
        self,
        *,
        config_overrides: Optional[ControlTowerClientConfig] = None,
        filter: Optional[
    ...
    ) -> "Iterator[capo_controltower.types.landing_zone_operation_summary.LandingZoneOperationSummary]":
        _token = next_token
        while True:
            _response = self.list_landing_zone_operations(
                config_overrides=config_overrides,
                filter=filter,
                next_token=_token,
                max_results=max_results,
    ...
    ) -> "Iterator[capo_controltower.types.landing_zone_summary.LandingZoneSummary]":
        _token = next_token
        while True:
            _response = self.list_landing_zones(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
