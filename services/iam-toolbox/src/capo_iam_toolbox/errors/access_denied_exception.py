"""Generated from Smithy shape ``com.amazonaws.iamtoolbox#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iamtoolbox#AccessDeniedException``."""
