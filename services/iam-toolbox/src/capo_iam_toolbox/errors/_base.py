...
class IAMToolboxError(Exception):
    """Base class for all IAMToolbox service errors."""


class ServiceError(IAMToolboxError):
...
class SerializationError(IAMToolboxError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IAMToolboxError):
...
class WaiterFailedError(IAMToolboxError):
...
class WaiterTimeoutError(IAMToolboxError):
