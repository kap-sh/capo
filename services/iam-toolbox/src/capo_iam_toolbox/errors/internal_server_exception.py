"""Generated from Smithy shape ``com.amazonaws.iamtoolbox#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iamtoolbox#InternalServerException``."""
