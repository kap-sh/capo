...
from capo_iam_toolbox._services._aws_config import aws_config
...
class IAMToolboxClientConfig(TypedDict, total=False, closed=True):
...
class IAMToolboxClient:
    ...
    def __init__(
        ...
        self._config = IAMToolboxClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[IAMToolboxClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: IAMToolboxClientConfig = config_overrides or {}
    ...
    def get_request_authorization_details(
        ...
        *,
        config_overrides: Optional[IAMToolboxClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[capo_iam_toolbox.types.get_request_authorization_details_input.GetRequestAuthorizationDetailsInput]",
        ) -> OperationResponse[
            "capo_iam_toolbox.types.get_request_authorization_details_output.GetRequestAuthorizationDetailsOutput"
        ]:
            ...
            output, http_response = (
                capo_iam_toolbox._operations.auth_request_service.get_request_authorization_details.get_request_authorization_details(
    ...
    def iter_get_request_authorization_details(
        self,
        authorization_id: str,
        *,
        config_overrides: Optional[IAMToolboxClientConfig] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_iam_toolbox.types.evaluation.Evaluation]":
        _token = next_token
        while True:
            _response = self.get_request_authorization_details(
                authorization_id,
