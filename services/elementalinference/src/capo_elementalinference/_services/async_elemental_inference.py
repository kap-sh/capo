...
class AsyncElementalInferenceClient:
    ...
    async def iter_list_dictionaries(
        self,
        *,
        config_overrides: Optional[AsyncElementalInferenceClientConfig] = None,
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[capo_elementalinference.types.dictionary_summary.DictionarySummary]":
        _token = next_token
        while True:
            _response = await self.list_dictionaries(
    ...
    async def iter_list_feeds(
        self,
        *,
        config_overrides: Optional[AsyncElementalInferenceClientConfig] = None,
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[capo_elementalinference.types.feed_summary.FeedSummary]":
        _token = next_token
        while True:
            _response = await self.list_feeds(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
