...
class AgentRegistryControlError(Exception):
    """Base class for all AgentRegistryControl service errors."""


class ServiceError(AgentRegistryControlError):
...
class SerializationError(AgentRegistryControlError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AgentRegistryControlError):
...
class WaiterFailedError(AgentRegistryControlError):
...
class WaiterTimeoutError(AgentRegistryControlError):
