"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#AgentSkillsDefinitionDescriptor``."""
...
if TYPE_CHECKING:
    import capo_agent_registry_control.types.agent_skills_additional_data
...
class AgentSkillsDefinitionDescriptor(TypedDict, closed=True):
    ...
    additional_data: NotRequired[
        "capo_agent_registry_control.types.agent_skills_additional_data.AgentSkillsAdditionalData"
    ]
...
def serialize_json(value: AgentSkillsDefinitionDescriptor) -> dict:
    ...
    if "additional_data" in value:
        ...
        out["additionalData"] = (
            capo_agent_registry_control.types.agent_skills_additional_data.serialize_json(
...
def deserialize_json(data: dict) -> AgentSkillsDefinitionDescriptor:
    ...
    if data.get("additionalData") is not None:
        ...
        out["additional_data"] = (
            capo_agent_registry_control.types.agent_skills_additional_data.deserialize_json(
                data["additionalData"]
            )
        )
    return out
