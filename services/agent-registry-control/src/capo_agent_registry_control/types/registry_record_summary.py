"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#RegistryRecordSummary``."""
...
class RegistryRecordSummary(TypedDict, closed=True):
    ...
    record_version: "capo_agent_registry_control.types.registry_record_version.RegistryRecordVersion"
...
def serialize_json(value: RegistryRecordSummary) -> dict:
    ...
    if "provenance_summary_list" in value:
        import capo_agent_registry_control.types.provenance_summary_list
...
def deserialize_json(data: dict) -> RegistryRecordSummary:
    ...
    if data.get("provenanceSummaryList") is not None:
        import capo_agent_registry_control.types.provenance_summary_list
