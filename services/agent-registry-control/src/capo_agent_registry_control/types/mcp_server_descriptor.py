"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#McpServerDescriptor``."""
...
if TYPE_CHECKING:
    ...
    import capo_agent_registry_control.types.mcp_server_additional_data
...
class McpServerDescriptor(TypedDict, closed=True):
    ...
    additional_data: NotRequired[
        "capo_agent_registry_control.types.mcp_server_additional_data.McpServerAdditionalData"
    ]
...
def serialize_json(value: McpServerDescriptor) -> dict:
    ...
    if "additional_data" in value:
        ...
        out["additionalData"] = (
            capo_agent_registry_control.types.mcp_server_additional_data.serialize_json(
...
def deserialize_json(data: dict) -> McpServerDescriptor:
    ...
    if data.get("additionalData") is not None:
        ...
        out["additional_data"] = (
            capo_agent_registry_control.types.mcp_server_additional_data.deserialize_json(
                data["additionalData"]
            )
        )
