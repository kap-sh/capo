"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#UpdatedHttpDescriptorFields``."""
...
class UpdatedHttpDescriptorFields(TypedDict, closed=True):
    source: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdatedHttpDescriptorFields) -> dict:
    out: dict = {}
    if "source" in value:
        import capo_agent_registry_control.types.updated_descriptor_source
...
def deserialize_json(data: dict) -> UpdatedHttpDescriptorFields:
    out: UpdatedHttpDescriptorFields = {}  # type: ignore[typeddict-item]
