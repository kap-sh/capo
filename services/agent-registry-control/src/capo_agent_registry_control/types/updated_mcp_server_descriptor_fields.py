"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#UpdatedMcpServerDescriptorFields``."""
...
if TYPE_CHECKING:
    ...
    import capo_agent_registry_control.types.updated_mcp_server_additional_data


class UpdatedMcpServerDescriptorFields(TypedDict, closed=True):
    data: NotRequired[
    ...
    additional_data: NotRequired[
        "capo_agent_registry_control.types.updated_mcp_server_additional_data.UpdatedMcpServerAdditionalData"
    ]
    """<p>The patch for the descriptor's additional data field.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: UpdatedMcpServerDescriptorFields) -> dict:
    out: dict = {}
    if "data" in value:
        import capo_agent_registry_control.types.updated_descriptor_data
    ...
    if "additional_data" in value:
        ...
        out["additionalData"] = (
            capo_agent_registry_control.types.updated_mcp_server_additional_data.serialize_json(
...
def deserialize_json(data: dict) -> UpdatedMcpServerDescriptorFields:
    out: UpdatedMcpServerDescriptorFields = {}  # type: ignore[typeddict-item]
    ...
    if data.get("additionalData") is not None:
        ...
        out["additional_data"] = (
            capo_agent_registry_control.types.updated_mcp_server_additional_data.deserialize_json(
                data["additionalData"]
            )
        )
    return out
