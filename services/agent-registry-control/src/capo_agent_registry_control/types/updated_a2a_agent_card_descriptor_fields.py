"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#UpdatedA2aAgentCardDescriptorFields``."""
...
class UpdatedA2aAgentCardDescriptorFields(TypedDict, closed=True):
    data: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdatedA2aAgentCardDescriptorFields) -> dict:
    out: dict = {}
    if "data" in value:
        import capo_agent_registry_control.types.updated_descriptor_data
...
def deserialize_json(data: dict) -> UpdatedA2aAgentCardDescriptorFields:
    out: UpdatedA2aAgentCardDescriptorFields = {}  # type: ignore[typeddict-item]
