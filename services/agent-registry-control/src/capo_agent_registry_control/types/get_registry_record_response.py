"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#GetRegistryRecordResponse``."""
...
def deserialize_json(data: dict) -> GetRegistryRecordResponse:
    ...
    if data.get("recordType") is not None:
        ...
        raise DeserializationError("GetRegistryRecordResponse.record_type required")
