...
from capo_agent_registry_control._services._aws_config import aaws_config
...
class AsyncAgentRegistryControlClientConfig(TypedDict, total=False, closed=True):
...
class AsyncAgentRegistryControlClient:
    ...
    def __init__(
        ...
        self._config = AsyncAgentRegistryControlClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncAgentRegistryControlClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncAgentRegistryControlClientConfig = config_overrides or {}
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_agent_registry_control.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_agent_registry_control.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_agent_registry_control._operations.agent_registry_control.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_agent_registry_control.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_agent_registry_control.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_agent_registry_control._operations.agent_registry_control.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_agent_registry_control.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_agent_registry_control.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_agent_registry_control._operations.agent_registry_control.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_agent_registry_control.types.registry_record_summary.RegistryRecordSummary]":
        _token = next_token
        while True:
    ...
    ) -> "AsyncIterator[capo_agent_registry_control.types.registry_summary.RegistrySummary]":
        _token = next_token
        while True:
