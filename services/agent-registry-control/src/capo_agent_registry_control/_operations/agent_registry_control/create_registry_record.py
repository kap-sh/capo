"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#CreateRegistryRecord``."""
...
import capo_agent_registry_control.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_agent_registry_control.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_agent_registry_control.types.create_registry_record_response.CreateRegistryRecordResponse = capo_agent_registry_control.types.create_registry_record_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_agent_registry_control.types.create_registry_record_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
