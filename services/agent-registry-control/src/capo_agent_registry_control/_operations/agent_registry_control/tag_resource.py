"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#TagResource``."""
...
def handle_response(
    ...
    out: capo_agent_registry_control.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_agent_registry_control.types.tag_resource_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
