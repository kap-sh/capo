"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#DeleteRegistry``."""
...
def handle_response(
    ...
    out: capo_agent_registry_control.types.delete_registry_response.DeleteRegistryResponse = capo_agent_registry_control.types.delete_registry_response.deserialize_json(
