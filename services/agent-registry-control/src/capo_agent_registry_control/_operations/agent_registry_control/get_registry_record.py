"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#GetRegistryRecord``."""
...
def handle_response(
    ...
    out: capo_agent_registry_control.types.get_registry_record_response.GetRegistryRecordResponse = capo_agent_registry_control.types.get_registry_record_response.deserialize_json(
