"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#GetRegistry``."""
...
def handle_response(
    ...
    out: capo_agent_registry_control.types.get_registry_response.GetRegistryResponse = (
        capo_agent_registry_control.types.get_registry_response.deserialize_json(
