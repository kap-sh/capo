"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#UpdateRegistryRecordStatus``."""
...
def handle_response(
    ...
    out: capo_agent_registry_control.types.update_registry_record_status_response.UpdateRegistryRecordStatusResponse = capo_agent_registry_control.types.update_registry_record_status_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_agent_registry_control.types.update_registry_record_status_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
