"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#UpdateRegistry``."""
...
def handle_response(
    ...
    out: capo_agent_registry_control.types.update_registry_response.UpdateRegistryResponse = capo_agent_registry_control.types.update_registry_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_agent_registry_control.types.update_registry_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
