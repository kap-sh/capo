"""Generated from Smithy shape ``com.amazonaws.agentregistrycontrol#SubmitRegistryRecordForApproval``."""
...
def handle_response(
    ...
    out: capo_agent_registry_control.types.submit_registry_record_for_approval_response.SubmitRegistryRecordForApprovalResponse = capo_agent_registry_control.types.submit_registry_record_for_approval_response.deserialize_json(
