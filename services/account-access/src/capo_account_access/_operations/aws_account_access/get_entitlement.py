"""Generated from Smithy shape ``com.amazonaws.accountaccess#GetEntitlement``."""
...
def handle_response(
    ...
    out: capo_account_access.types.get_entitlement_response.GetEntitlementResponse = (
        capo_account_access.types.get_entitlement_response.deserialize_json(
...
async def async_get_entitlement(
