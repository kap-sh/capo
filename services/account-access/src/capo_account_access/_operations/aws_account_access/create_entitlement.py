"""Generated from Smithy shape ``com.amazonaws.accountaccess#CreateEntitlement``."""
...
import capo_account_access.errors.conflict_exception
...
import capo_account_access.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_account_access.errors.conflict_exception.ConflictException.from_json(
                data, message
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_account_access.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_account_access.types.create_entitlement_response.CreateEntitlementResponse = capo_account_access.types.create_entitlement_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/entitlements"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_account_access.types.create_entitlement_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
