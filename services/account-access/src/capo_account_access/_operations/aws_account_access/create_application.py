"""Generated from Smithy shape ``com.amazonaws.accountaccess#CreateApplication``."""
...
import capo_account_access.errors.already_created_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AlreadyCreatedException":
            raise capo_account_access.errors.already_created_exception.AlreadyCreatedException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_account_access.types.create_application_response.CreateApplicationResponse = capo_account_access.types.create_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_account_access.types.create_application_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
