"""Generated from Smithy shape ``com.amazonaws.accountaccess#DeleteEntitlement``."""
...
def handle_response(
    ...
    out: capo_account_access.types.delete_entitlement_response.DeleteEntitlementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/entitlements/{entitlementId}"
    url = url.replace("{entitlementId}", quote(input_["entitlement_id"], safe=""))
    params: list[tuple[str, str]] = []
    if "application_arn" in input_:
        params.append(("applicationArn", input_["application_arn"]))
