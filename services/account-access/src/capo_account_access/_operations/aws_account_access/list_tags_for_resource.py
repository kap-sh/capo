"""Generated from Smithy shape ``com.amazonaws.accountaccess#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_account_access.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_account_access.types.list_tags_for_resource_response.deserialize_json(
