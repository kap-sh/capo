"""Generated from Smithy shape ``com.amazonaws.accountaccess#UntagResource``."""
...
def handle_response(
    ...
    out: capo_account_access.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
