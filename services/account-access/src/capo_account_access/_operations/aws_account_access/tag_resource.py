"""Generated from Smithy shape ``com.amazonaws.accountaccess#TagResource``."""
...
def handle_response(
    ...
    out: capo_account_access.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_account_access.types.tag_resource_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_account_access.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
