"""Generated from Smithy shape ``com.amazonaws.accountaccess#DeleteApplication``."""
...
def handle_response(
    ...
    out: capo_account_access.types.delete_application_response.DeleteApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationArn}"
    url = url.replace("{applicationArn}", quote(input_["application_arn"], safe=""))
