"""Generated from Smithy shape ``com.amazonaws.accountaccess#GetApplication``."""
...
def handle_response(
    ...
    out: capo_account_access.types.get_application_response.GetApplicationResponse = (
        capo_account_access.types.get_application_response.deserialize_json(
