"""Generated from Smithy shape ``com.amazonaws.accountaccess#ListApplications``."""
...
def handle_response(
    ...
    out: capo_account_access.types.list_applications_response.ListApplicationsResponse = capo_account_access.types.list_applications_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/applications-list"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_account_access.types.list_applications_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
