...
class AccountAccessError(Exception):
    """Base class for all AccountAccess service errors."""


class ServiceError(AccountAccessError):
...
class SerializationError(AccountAccessError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AccountAccessError):
...
class WaiterFailedError(AccountAccessError):
...
class WaiterTimeoutError(AccountAccessError):
