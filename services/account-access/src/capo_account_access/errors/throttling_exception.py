"""Generated from Smithy shape ``com.amazonaws.accountaccess#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.accountaccess#ThrottlingException``."""
