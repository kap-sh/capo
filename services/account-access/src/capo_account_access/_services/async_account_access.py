...
from capo_account_access._resources.aws_account_access.application import (
    AsyncApplication,
)
from capo_account_access._services._aws_config import aaws_config
...
class AsyncAccountAccessClientConfig(TypedDict, total=False, closed=True):
...
class AsyncAccountAccessClient:
    ...
    def __init__(
        ...
        self._config = AsyncAccountAccessClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncAccountAccessClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncAccountAccessClientConfig = config_overrides or {}
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_account_access.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_account_access.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_account_access._operations.aws_account_access.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_account_access.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_account_access.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_account_access._operations.aws_account_access.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_account_access.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_account_access.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_account_access._operations.aws_account_access.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_applications(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[capo_account_access.types.application_summary.ApplicationSummary]":
        _token = next_token
        while True:
    ...
    async def iter_list_entitlements(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[capo_account_access.types.entitlements_list_member.EntitlementsListMember]":
        _token = next_token
        while True:
